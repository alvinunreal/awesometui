...
[![Projects](https://img.shields.io/badge/projects-1%2C343-b8860b?style=flat-square)](#contents)
[![Categories](https://img.shields.io/badge/categories-19-3b7dd8?style=flat-square)](#contents)
[![Deep dives](https://img.shields.io/badge/deep_dives-108-8a4fff?style=flat-square)](https://awesometui.com)
[![Updated](https://img.shields.io/badge/synced-2026-09-14-2ea043?style=flat-square)](#how-this-list-is-built)
...
This README is generated from the live catalog at [awesometui.com](https://awesometui.com): **1,343 published projects** across **19 categories** and **12 focused sub-collections**. Every entry is a real GitHub repository that was imported, classified, and reviewed for being an actual terminal UI (not just a CLI). Star counts and languages are synced from GitHub; 108 projects also have a full **deep dive** page with install options, keybindings, and screenshots.
...
- **Data & Files** <sub>(177)</sub>
  - [File Management](#file-management) <sub>(89)</sub>
  - [Database Clients](#database-clients) <sub>(29)</sub>
  - [Text Processing](#text-processing) <sub>(59)</sub>
- **Work & Communication** <sub>(142)</sub>
  - [Productivity](#productivity) <sub>(107)</sub> — [Task Managers](#task-managers) · [Email](#email)
...
- [ghgrab](https://github.com/abhixdd/ghgrab) - A simple, pretty terminal tool that lets you browse and download files from GitHub, GitLab, Codeberg, Gitea, and Forgejo without leaving your CLI. <sub>`Rust` · ★ 1.4k</sub>
...
- [ggh](https://github.com/byawitz/ggh) - Recall your SSH sessions (also search your SSH config file) <sub>`Go` · ★ 954</sub>
...
- [has](https://github.com/kdabir/has) - ✅ checks presence of various command line tools and their versions on the path. <sub>`Shell` · ★ 820</sub>
- [halp](https://github.com/orhun/halp) - A CLI tool to get help with CLI tools 🐙. <sub>`Rust` · ★ 768</sub>
- [mani](https://github.com/alajmo/mani) - Robot: CLI tool to help you manage repositories. <sub>`Go` · ★ 764</sub>
...
- [personal-os-setup](https://github.com/AmineDjeghri/personal-os-setup) - An app and guide to easily configure Windows, Linux, MacOS, Google TV, Stremio, Home Assistant and more (including WSL2, GPU drivers & development tools). Improve your UX & productivity. <sub>`Python` · ★ 613</sub>
- [nemu](https://github.com/nemuTUI/nemu) - Ncurses UI for QEMU. <sub>`C` · ★ 605</sub>
- [devtui](https://github.com/skatkov/devtui) - A Swiss-army app for developers. <sub>`Go` · ★ 554 · [deep dive](https://awesometui.com/devtui)</sub>
...
- [octocov](https://github.com/k1LoW/octocov) - Octocov is a toolkit for collecting code metrics (code coverage, code to test ratio, test execution time and your own custom metrics). <sub>`Go` · ★ 510</sub>
...
- [agent-manager](https://github.com/YoanWai/agent-manager) - The fastest workflow for every AI coding agent. Live status, quick prompts, worktrees, and diff review from one tmux TUI. <sub>`Go` · ★ 436 · [deep dive](https://awesometui.com/agent-manager)</sub>
- [gophertube](https://github.com/KrishnaSSH/gophertube) - A modern terminal user interface for searching and watching YouTube videos using mpv and chafa. <sub>`Go` · ★ 431</sub>
...
- [resend-cli](https://github.com/resend/resend-cli) - The official CLI for Resend. <sub>`TypeScript` · ★ 394</sub>
...
- [epiq](https://github.com/ljtn/epiq) - Distributed, code-native issue tracker - audit workflows via time-travel. <sub>`TypeScript` · ★ 378</sub>
- [lazyjira](https://github.com/textfuel/lazyjira) - Lazygit but for Jira. <sub>`Go` · ★ 366</sub>
...
- [oyo](https://github.com/ahkohd/oyo) - Your not yet complete terminal code review tool. <sub>`Rust` · ★ 347</sub>
...
- [noodle](https://github.com/wilfredinni/noodle) - A delicious REST client for your terminal. <sub>`TypeScript` · ★ 327 · [deep dive](https://awesometui.com/noodle)</sub>
...
- [try-rs](https://github.com/tassiovirginio/try-rs) - A blazing fast, Rust-based workspace manager for your temporary experiments. <sub>`Rust` · ★ 287</sub>
...
- [lazyskills](https://github.com/alvinunreal/lazyskills) - Mission control for agent skills. <sub>`Go` · ★ 244 · [deep dive](https://awesometui.com/lazyskills)</sub>
...
- [envx](https://github.com/mikeleppane/envx) - A powerful and secure environment variable manager for developers, featuring an intuitive Terminal User Interface (TUI) and comprehensive command-line interface. <sub>`Rust` · ★ 230</sub>
- [glab-tui](https://github.com/rcieri/glab-tui) - A terminal user interface (TUI) for GitLab/GitHub, built on top of glab/gh. Browse issues, merge requests, pipelines, runners, and releases without leaving your terminal. Built for personal use. <sub>`Rust` · ★ 230</sub>
- [splashboard](https://github.com/unhappychoice/splashboard) - A customizable terminal splash screen with plugin-based data sources. <sub>`Rust` · ★ 216</sub>
- [lazymake](https://github.com/rshelekhov/lazymake) - Modern TUI for Makefiles with interactive target selection, dependency visualization, and command safety analysis. <sub>`Go` · ★ 212</sub>
...
- [mandible](https://github.com/AS-FOSS/mandible) - A Universal TUI Manual Viewer for CLI Tools in Rust. <sub>`Rust` · ★ 194</sub>
- [gcli](https://github.com/herrhotzenplotz/gcli) - Portable Git(hublabtea)/Forgejo/Bugzilla CLI tool, Submit patches here: https://lists.sr.ht/~herrhotzenplotz/gcli-devel. <sub>`C` · ★ 191</sub>
...
- [oyui](https://github.com/emilien-jegou/oyui) - Modern TUI merge tool and interactive diff editor for Jujutsu (jj) and Git. <sub>`Rust` · ★ 154</sub>
...
- [codemark](https://github.com/DanielCardonaRojas/codemark) - A semantic code bookmarking system for humans and agents. <sub>`Rust` · ★ 122</sub>
...
- [gitsocial](https://github.com/gitsocial-org/gitsocial) - Git-native collaboration platform. <sub>`Go` · ★ 121</sub>
...
- [spectatui](https://github.com/tinesoft/spectatui) - A TUI (Terminal UI) dashboard for Github Spec-Kit. <sub>`Rust` · ★ 81</sub>
- [lazyslurm](https://github.com/hill/lazyslurm) - Like lazygit/lazydocker but for slurm. <sub>`Rust` · ★ 80</sub>
...
- [leetrs](https://github.com/shadowmkj/leetrs) - Leetrs is a blazing-fast, Rust-powered CLI and engine designed to make solving LeetCode problems from the terminal a first-class developer experience. <sub>`Rust` · ★ 77 · [deep dive](https://awesometui.com/leetrs)</sub>
...
- [omp-manager](https://github.com/psmux/omp-manager) - Installation and manager for Oh My Posh! The one thing you need to browse themes, install fonts, and configure shells. <sub>`Rust` · ★ 70</sub>
...
- [octoscope](https://github.com/gfazioli/octoscope) - Terminal dashboard for GitHub — followers, stars, PRs and issues at a glance, auto-refreshed. <sub>`Go` · ★ 62</sub>
...
- [kranz](https://github.com/kranz-org/kranz) - Keyboard-first local service orchestrator with a focused terminal UI. <sub>`Go` · ★ 58 · [deep dive](https://awesometui.com/kranz)</sub>
...
- [wintui](https://github.com/kts982/wintui) - Go TUI frontend for winget (Windows Package Manager) — built with Bubble Tea, Bubbles, and Lip Gloss. <sub>`Go` · ★ 37</sub>
...
- [proqi](https://github.com/oborchers/proqi) - A terminal-native prompt composer for power users running multiple coding agents. <sub>`Rust` · ★ 29 · [deep dive](https://awesometui.com/proqi)</sub>
...
- [revision](https://github.com/bapatchirag/revision) - Lazygit for SVN - a fast, keyboard-driven TUI for SVN. <sub>`Go` · ★ 9 · [deep dive](https://awesometui.com/revision)</sub>
...
- [lazymqtt](https://github.com/ScottFelder/lazymqtt) - Terminal UI MQTT client with features like saved connections, live topic tree, message inspector, and plugins. <sub>`Rust` · ★ 6 · [deep dive](https://awesometui.com/lazymqtt)</sub>
...
- [Livediff](https://github.com/SoCkEt7/Livediff) - 👁️ Real-time file monitoring with beautiful live diff visualization in the terminal. Built in Rust 🦀. <sub>`Rust` · ★ 1</sub>
...
- [branchlet](https://github.com/raghavpillai/branchlet) - Branchlet: A simple CLI Git worktree manager. <sub>`TypeScript` · ★ 497</sub>
...
- [ec](https://github.com/chojs23/ec) - Terminal-native 3-way git mergetool and diff viewer. <sub>`Go` · ★ 298</sub>
- [lazyworktree](https://github.com/chmouel/lazyworktree) - Easy Git worktree management CLI and TUI for the terminal. <sub>`Go` · ★ 295</sub>
...
- [gitpane](https://github.com/affromero/gitpane) - Multi-repo Git workspace dashboard for the terminal. <sub>`Rust` · ★ 131</sub>
...
- [brows](https://github.com/rubysolo/brows) - CLI GitHub release browser. <sub>`Go` · ★ 85</sub>
- [gitwig](https://github.com/tareqmy/gitwig) - A rust based tui an alternative to sourcetree. <sub>`Rust` · ★ 85</sub>
...
- [fresh](https://github.com/sinelaw/fresh) - Terminal based IDE & text editor: easy, powerful and fast. <sub>`Rust` · ★ 8.9k</sub>
...
- [moe](https://github.com/fox0430/moe) - A command line based editor inspired by Vim. Written in Nim. <sub>`Nim` · ★ 722</sub>
- [orbiton](https://github.com/xyproto/orbiton) - Snappy and configuration-free text editor/IDE for the terminal. Suitable for writing git commit messages, editing Markdown, config files, source code, man pages and for quick edit-format-compile… <sub>`Go` · ★ 700 · [deep dive](https://awesometui.com/orbiton)</sub>
- [turbo](https://github.com/magiblot/turbo) - An experimental text editor based on Scintilla and Turbo Vision. <sub>`C++` · ★ 682</sub>
- [elinks](https://github.com/rkd77/elinks) - Fork of elinks. <sub>`C` · ★ 633</sub>
- [tilde](https://github.com/gphalkes/tilde) - The Tilde text editor. <sub>`C++` · ★ 554</sub>
- [mdfried](https://github.com/benjajaja/mdfried) - A markdown viewer for the terminal that renders images and Big Headers™. <sub>`Rust` · ★ 512</sub>
- [tut](https://github.com/RasmusLindroth/tut) - TUI for Mastodon with vim inspired keys. <sub>`Go` · ★ 501</sub>
- [emeraldian](https://github.com/iamrohithrnair/emeraldian) - A terminal UI for your Obsidian vault: live-preview notes, backlinks, images, a force-directed graph and an assistant. <sub>`Rust` · ★ 473</sub>
- [dawn](https://github.com/andrewmd5/dawn) - A distraction-free writing environment; draft anything, write now. <sub>`C` · ★ 459</sub>
- [hygg](https://github.com/kruseio/hygg) - 📚 Simplifying the way you read. Minimalistic Vim-like TUI document reader. <sub>`Rust` · ★ 353</sub>
...
- [ttt](https://github.com/eugenioenko/ttt) - TTT Editor (Terminal Text Tool): A real alternative to VS Code, Zed, and Sublime that runs in your terminal. A TUI that feels like GUI. Single binary, zero config. <sub>`Go` · ★ 262</sub>
...
- [toast](https://github.com/paradise-runner/toast) - A batteries-included, beautiful, in-terminal IDE. <sub>`Go` · ★ 207</sub>
...
- [claws](https://github.com/clawscli/claws) - K9s-inspired TUI for AWS resource management with vim-style navigation. <sub>`Go` · ★ 157</sub>
...
- [markln](https://github.com/xqtr/markln) - A MarkDown editor, with live preview, for use in the Terminal. <sub>`Python` · ★ 62</sub>
...
- [mnml](https://github.com/chris-mclennan/mnml) - A NvChad-style terminal IDE in Rust — vim or standard editing, LSP, git, embedded HTTP/CDP/DAP, AI panes, headless test harness. One binary. <sub>`Rust` · ★ 16 · [deep dive](https://awesometui.com/mnml)</sub>
...
- [pyTermTk](https://github.com/ceccopierangiolieugenio/pyTermTk) - Python Terminal Toolkit - a Spiced Up Cross Compatible TUI Library 🌶️. <sub>`Python` · ★ 917</sub>
- [Consolonia](https://github.com/Consolonia/Consolonia) - A cross-platform UI framework for .NET. <sub>`C#` · ★ 826</sub>
...
- [termbox2](https://github.com/termbox/termbox2) - Terminal I/O library. <sub>`C` · ★ 767</sub>
...
- [nocterm](https://github.com/Norbert515/nocterm) - A powerful, Flutter-inspired Terminal User Interface framework for building beautiful command-line applications in Dart. <sub>`Dart` · ★ 400</sub>
...
- [ConsoleEx](https://github.com/nickprotop/ConsoleEx) - SharpConsoleUI — A reactive terminal UI framework for .NET with a robust async model, per-window threads, a real compositor engine, 30+ controls, and NativeAOT support. <sub>`C#` · ★ 273</sub>
...
- [unicurses](https://github.com/unicurses/unicurses) - Github fork for unicurses. <sub>`Python` · ★ 174</sub>
- [tui4j](https://github.com/WilliamAGH/tui4j) - TUI4J: Terminal User Interface library for Java that includes Bubble Tea ported from Go. <sub>`Java` · ★ 123</sub>
...
- [opencode](https://github.com/anomalyco/opencode) - The open source coding agent. <sub>`TypeScript` · ★ 207k</sub>
- [claude-code](https://github.com/anthropics/claude-code) - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows… <sub>`Python` · ★ 145k</sub>
...
- [herdr](https://github.com/herdrdev/herdr) - The runtime your coding agents live on. <sub>`Rust` · ★ 38k · [deep dive](https://awesometui.com/herdr)</sub>
...
- [pixtuoid](https://github.com/IvanWng97/pixtuoid) - Terminal pixel-art office for AI coding agents. <sub>`Rust` · ★ 476</sub>
...
- [ollama](https://github.com/ollama/ollama) - Get up and running with Kimi-K2.6, GLM-5.2, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models. <sub>`Go` · ★ 181k</sub>
- [codex](https://github.com/openai/codex) - Lightweight coding agent that runs in your terminal. <sub>`Rust` · ★ 124k</sub>
- [llmfit](https://github.com/AlexsJones/llmfit) - Hundreds of models & providers. One command to find what runs on your hardware. <sub>`Rust` · ★ 36k · [deep dive](https://awesometui.com/llmfit)</sub>
...
- [VTCode](https://github.com/vinhnx/VTCode) - VT Code is an open-source Rust terminal coding agent. <sub>`Rust` · ★ 842</sub>
- [oatmeal](https://github.com/dustinblackman/oatmeal) - Terminal UI to chat with large language models (LLM) using different model backends, and integrations with your favourite editors! <sub>`Rust` · ★ 771</sub>
- [tenere](https://github.com/pythops/tenere) - 🤖 TUI for LLMs. <sub>`Rust` · ★ 683</sub>
- [agentty](https://github.com/1ay1/agentty) - AI pair programming in your terminal — one static binary, sub-ms startup, any model. <sub>`C++` · ★ 600 · [deep dive](https://awesometui.com/agentty)</sub>
...
- [models](https://github.com/reyamira/models) - TUI and CLI for browsing models.dev, benchmarks, coding agents, and statuses for AI providers. <sub>`Rust` · ★ 506</sub>
- [parllama](https://github.com/paulrobello/parllama) - TUI for Ollama and other LLM providers. <sub>`Python` · ★ 490</sub>
- [phi](https://github.com/pulseaiclub/phi) - A coding agent, rpc plugin, sub-agents, hashline edits, and mcp. <sub>`Go` · ★ 382</sub>
...
- [amux](https://github.com/andyrewlee/amux) - TUI for easily running parallel coding agents. <sub>`Go` · ★ 160</sub>
- [fast-resume](https://github.com/angristan/fast-resume) - Find that one coding agent session you want to get back to! <sub>`Rust` · ★ 157</sub>
...
- [Martty](https://github.com/openma-ai/Martty) - Unified Harness TUI (ACP client). Self-Improvement TUI plugin of DeepSeek Harness. Everything Here Is Also A Plugin. <sub>`Rust` · ★ 74 · [deep dive](https://awesometui.com/martty)</sub>
...
- [purple](https://github.com/erickochen/purple) - Free, open-source terminal SSH manager and SSH config editor in Rust for macOS and Linux that keeps ~/.ssh/config in sync with 18 cloud providers, monitors live SSH tunnels and manages Docker and… <sub>`Rust` · ★ 687</sub>
- [lazycontainer](https://github.com/andreybleme/lazycontainer) - Fancy terminal UI for Apple Containers. <sub>`Go` · ★ 371</sub>
- [DockMate](https://github.com/shubh-io/DockMate) - Dockmate: The open-source Docker TUI & Podman manager for terminal productivity. A fast, lightweight alternative to lazydocker built in Go. <sub>`Go` · ★ 338</sub>
...
- [layerx](https://github.com/deveshctl/layerx) - LayerX Image Inspector - open-source terminal explorer for container images. Browse layers, spot wasted bytes, and gate CI on image efficiency. <sub>`Go` · ★ 129</sub>
- [d4s](https://github.com/jr-k/d4s) - 🍊 A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s. <sub>`Go` · ★ 128</sub>
...
- [docker-dash](https://github.com/GustavoCaso/docker-dash) - A full TUI managemnet tool for containers 🏗️. <sub>`Go` · ★ 23</sub>
...
- [e1s](https://github.com/keidarcy/e1s) - E1S - Easily Manage AWS ECS Resources in Terminal(~k9s for ECS) 🐱. <sub>`Go` · ★ 928</sub>
- [lfk](https://github.com/janosmiko/lfk) - ⚡ LFK is a lightning-fast, keyboard-focused, yazi-inspired terminal user interface for navigating and managing Kubernetes clusters. <sub>`Go` · ★ 888 · [deep dive](https://awesometui.com/lfk)</sub>
- [ku](https://github.com/bjarneo/ku) - A fast, keyboard-driven Kubernetes TUI. Browse any resource, edit objects, follow logs, and shell into pods. <sub>`Go` · ★ 551</sub>
...
- [sofka](https://github.com/nklmilojevic/sofka) - A Kubernetes TUI, reimagined in Rust - built on kube-rs and ratatui, async-first from the ground up. <sub>`Rust` · ★ 1.1k</sub>
...
- [argonaut](https://github.com/darksworm/argonaut) - Keyboard-first terminal UI for Argo CD. Browse apps, scope by clusters/namespaces/projects, stream live resource status, trigger syncs, inspect diffs, and roll back safely — all without leaving your… <sub>`Go` · ★ 448</sub>
- [tori-cli](https://github.com/thobiasn/tori-cli) - Docker server monitoring without the stack. Metrics, logs, and alerts from your terminal. Single binary, zero exposed ports, SSH-only. <sub>`Go` · ★ 315</sub>
...
- [sshelf](https://github.com/max-rh/sshelf) - Fast terminal UI for your SSH hosts: fuzzy-search and connect in two keystrokes, dual-pane SFTP file transfer, and background port forwarding. <sub>`Rust` · ★ 71</sub>
...
- [caps-log](https://github.com/NikolaDucak/caps-log) - A small TUI journaling tool. 📖. <sub>`C++` · ★ 402</sub>
...
- [nv-monitor](https://github.com/wentbackward/nv-monitor) - Lightweight nVidia telemetry and terminal system monitor - built for any architecture - Jetson, GB10, GB200, H100. <sub>`C` · ★ 322</sub>
...
- [psnet](https://github.com/psmux/psnet) - A beautiful real-time TUI network monitor for Windows PowerShell — built in Rust. <sub>`Rust` · ★ 146</sub>
...
- [Heimdall](https://github.com/kinncj/Heimdall) - Heimdall is a lightweight, cross-platform hardware monitoring system with a real-time terminal dashboard. <sub>`Go` · ★ 67</sub>
...
- [lazyrsync](https://github.com/westpoint-io/lazyrsync) - 🦀 A friendly terminal UI for rsync, written in Rust. Reusable profiles, an honest dry-run diff, and live progress, even over SSH. <sub>`Rust` · ★ 794 · [deep dive](https://awesometui.com/lazyrsync)</sub>
- [omnyssh](https://github.com/timhartmann7/omnyssh) - A fast, keyboard-driven TUI for managing SSH connections, written in Rust. <sub>`Rust` · ★ 498</sub>
- [fztea](https://github.com/jon4hz/fztea) - 🐬🧋 Remote control your flipper from the local terminal or over SSH. <sub>`Go` · ★ 401</sub>
- [lssh](https://github.com/blacknon/lssh) - A terminal-native remote access suite for SSH, cloud inventories, provider-backed connectors, parallel commands, mux workspaces, file transfer, and monitoring. <sub>`Go` · ★ 325</sub>
...
- [sshclick](https://github.com/karlot/sshclick) - SSH Config terminal manager based on Python and Click framework with Rich and Textual UI. <sub>`Python` · ★ 189</sub>
...
- [servonaut](https://github.com/zb-ss/servonaut) - Manage AWS, Hetzner, OVH, and custom servers from one TUI — with a built-in AI assistant and MCP server. <sub>`Python` · ★ 25</sub>
...
- [netwatch](https://github.com/matthart1983/netwatch) - Real-time network diagnostics in your terminal. One command, zero config, instant visibility. <sub>`Rust` · ★ 3.1k</sub>
...
- [mqttui](https://github.com/EdJoPaTo/mqttui) - Subscribe to a MQTT topic or publish something quickly from the terminal. <sub>`Rust` · ★ 725</sub>
...
- [xfr](https://github.com/lance0/xfr) - A modern iperf3 alternative with a live TUI, multi-client server, and QUIC support. Built in Rust. <sub>`Rust` · ★ 536</sub>
- [flow](https://github.com/programmersd21/flow) - See ur network breathe. <sub>`Go` · ★ 452</sub>
- [slurm](https://github.com/mattthias/slurm) - Yet another network load monitor. <sub>`C` · ★ 423</sub>
- [network-doctor](https://github.com/heymaikol/network-doctor) - Network Doctor is a cross-platform network troubleshooting TUI that turns interface, DNS, TCP, TLS, HTTP, proxy, and path-MTU checks into one plain-English diagnosis. <sub>`Go` · ★ 372</sub>
...
- [dnspyre](https://github.com/Tantalor93/dnspyre) - CLI tool for a high QPS DNS benchmark. <sub>`Go` · ★ 328</sub>
- [netop](https://github.com/ZingerLittleBee/netop) - Network Top -- Help you monitor network traffic with bpf. <sub>`Rust` · ★ 268</sub>
- [unifly](https://github.com/hyperb1iss/unifly) - 🌐 Elegant UniFi network management CLI & TUI - for humans and agents. <sub>`Rust` · ★ 256</sub>
- [lsoff](https://github.com/yutat23/lsoff) - CLI / TUI that lists listening TCP/UDP ports. <sub>`Go` · ★ 249 · [deep dive](https://awesometui.com/lsoff)</sub>
- [cidr](https://github.com/bschaatsbergen/cidr) - Simplifies IPv4/IPv6 CIDR network prefix management with counting, overlap checking, explanation, and subdivision. <sub>`Go` · ★ 243</sub>
...
- [ls-horizons](https://github.com/litescript/ls-horizons) - Terminal UI for visualizing NASA's Deep Space Network in real-time. <sub>`Go` · ★ 84</sub>
...
- [portop](https://github.com/padovanl/portop) - 🔌 What's really using your ports? htop-style TUI, one keypress to kill it. <sub>`Go` · ★ 5 · [deep dive](https://awesometui.com/portop)</sub>
...
- [taproom](https://github.com/hzqtc/taproom) - An interactive TUI for Homebrew. <sub>`Go` · ★ 724</sub>
- [pacseek](https://github.com/moson-mo/pacseek) - A terminal user interface for searching and installing Arch Linux packages. <sub>`Go` · ★ 659</sub>
- [bold-brew](https://github.com/Valkyrie00/bold-brew) - Bold Brew (bbrew) - A Homebrew TUI Manager. <sub>`Go` · ★ 440</sub>
- [aptui](https://github.com/mexirica/aptui) - TUI package manager for APT-based Linux distributions. <sub>`Go` · ★ 421</sub>
...
- [Pacsea](https://github.com/Firstp1ck/Pacsea) - Fast TUI for searching, inspecting, and queueing pacman/AUR packages. <sub>`Rust` · ★ 296</sub>
- [cargo-seek](https://github.com/tareqimbasher/cargo-seek) - A terminal user interface for searching, adding and installing cargo crates. <sub>`Rust` · ★ 200</sub>
- [malt](https://github.com/indaco/malt) - Homebrew's whole ecosystem, none of its weight - a single Zig binary with native postinstall and a themeable TUI & CLI. <sub>`Zig` · ★ 165</sub>
...
- [syswatch](https://github.com/matthart1983/syswatch) - Single-host system diagnostics TUI. Sibling to netwatch. Twelve tabs, plain-English insights, session scrubber. macOS + Linux. <sub>`Rust` · ★ 875</sub>
- [pvetui](https://github.com/devnullvoid/pvetui) - Terminal UI for Proxmox VE. <sub>`Go` · ★ 722</sub>
- [jolt](https://github.com/jordond/jolt) - ⚡️A terminal-based battery and energy monitor for macOS and Linux. <sub>`Rust` · ★ 553</sub>
- [heretek](https://github.com/wcampbell0x2a/heretek) - GDB TUI Dashboard for the understanding of vast knowledge. <sub>`Rust` · ★ 390</sub>
- [diskwatch](https://github.com/matthart1983/diskwatch) - Single-host, read-only disk diagnostics TUI. Sibling to netwatch and syswatch. <sub>`Rust` · ★ 377</sub>
...
- [rura](https://github.com/tlipinski/rura) - Terminal UI for building shell pipelines. <sub>`Rust` · ★ 334 · [deep dive](https://awesometui.com/rura)</sub>
...
- [pstop](https://github.com/psmux/pstop) - Htop for Windows . TUI system monitor with per-core CPU bars, memory/swap/network, tree view, process kill, 7 color schemes, mouse support. cargo install pstop. <sub>`Rust` · ★ 246</sub>
...
- [CrunchyCleaner](https://github.com/Knuspii/CrunchyCleaner) - 💾🧹 A lightweight, software cache cleanup tool for Windows & Linux. <sub>`Go` · ★ 155</sub>
...
- [xfetch](https://github.com/xfetch-cli/xfetch) - Xfetch kernel. <sub>`Rust` · ★ 94</sub>
...
- [zigfetch](https://github.com/utox39/zigfetch) - Zigfetch is a minimal neofetch/fastfetch like system information tool. <sub>`Zig` · ★ 50</sub>
...
- [apw](https://github.com/bendews/apw) - A CLI for Apple Passwords (also known as iCloud Keychain) <sub>`TypeScript` · ★ 247</sub>
...
- [pass-cli](https://github.com/reyamira/pass-cli) - A secure, cross-platform, always-free, and open-source alternative to 1password, bitwarden, etc., Password and API key manager for folks who live in the command line. (CLI + TUI) <sub>`Go` · ★ 107</sub>
...
- [y509](https://github.com/kanywst/y509) - TUI for X.509 certificate chains: verifies trust, and catches the missing intermediates and bad ordering that break curl but not browsers. <sub>`Go` · ★ 29 · [deep dive](https://awesometui.com/y509)</sub>
...
- [jaiba](https://github.com/rama-oi/jaiba) - Terminal password manager for KeePass vaults. <sub>`Rust` · ★ 21 · [deep dive](https://awesometui.com/jaiba)</sub>
- [kvn](https://github.com/yarikov/kvn) - 🛡️ TUI VPN client for Arch Linux. Paste vless://, vmess://, trojan://, ss:// & more — manage sing-box, routing, kill switch & DNS without leaving the terminal. <sub>`Rust` · ★ 20 · [deep dive](https://awesometui.com/kvn)</sub>
...
- [mc](https://github.com/MidnightCommander/mc) - Midnight Commander's repository. <sub>`C` · ★ 977</sub>
- [pls](https://github.com/pls-rs/pls) - Pls is a prettier and powerful ls(1) for the pros. <sub>`Rust` · ★ 965</sub>
- [elio](https://github.com/elio-fm/elio) - Snappy, batteries-included terminal file manager with rich previews, inline images, bulk actions, and trash support. <sub>`Rust` · ★ 858</sub>
...
- [parallel-disk-usage](https://github.com/KSXGitHub/parallel-disk-usage) - Highly parallelized, blazing fast directory tree analyzer. <sub>`Rust` · ★ 728</sub>
- [nomino](https://github.com/yaa110/nomino) - Batch rename utility for developers. <sub>`Rust` · ★ 708</sub>
- [parqeye](https://github.com/kaushiksrini/parqeye) - Peek inside Parquet files right from your terminal. <sub>`Rust` · ★ 679</sub>
- [browsr](https://github.com/juftin/browsr) - 🗂️ a pleasant file explorer in your terminal supporting all filesystems. <sub>`Python` · ★ 647</sub>
- [fm](https://github.com/mistakenelf/fm) - A terminal based file manager. <sub>`Go` · ★ 634</sub>
- [gomi](https://github.com/babarot/gomi) - 🗑️ Your UNIX rm command with a safety net! <sub>`Go` · ★ 572</sub>
- [projectable](https://github.com/dzfrias/projectable) - Dizzy: A TUI file manager built for projects. <sub>`Rust` · ★ 461</sub>
- [mac-cleanup-go](https://github.com/2ykwang/mac-cleanup-go) - TUI macOS cleaner that scans caches/logs, shows sizes/paths, lets you select what to delete before Trash. <sub>`Go` · ★ 460</sub>
- [tran](https://github.com/abdfnx/tran) - 🖥 Securely transfer and send anything between computers with TUI. <sub>`Go` · ★ 447</sub>
- [rovr](https://github.com/NSPC911/rovr) - A stylish, batteries-included terminal file manager. <sub>`Python` · ★ 410</sub>
- [dskDitto](https://github.com/jdefrancesco/dskDitto) - Ultra fast and easy duplicate file finder. Awesome TUI/GUI to manage results. <sub>`Go` · ★ 382</sub>
...
- [gtrash](https://github.com/umlx5h/gtrash) - A Featureful Trash CLI manager: alternative to rm and trash-cli. <sub>`Go` · ★ 320</sub>
- [hazelnut](https://github.com/ricardodantas/hazelnut) - 🌰 Terminal-based automated file organizer inspired by Hazel. Watch folders and organize files with rules. <sub>`Rust` · ★ 297</sub>
...
- [wiper](https://github.com/ikebastuz/wiper) - Disk analyser and cleanup tool. <sub>`Rust` · ★ 249</sub>
...
- [cull](https://github.com/legostin/cull) - Interactive TUI disk space analyzer. <sub>`Go` · ★ 161</sub>
- [redu](https://github.com/drdo/redu) - Ncdu for your restic repository. <sub>`Rust` · ★ 153</sub>
- [darya](https://github.com/mrkatebzadeh/darya) - Disk usage explorer with a TUI and live treemap. <sub>`Rust` · ★ 151</sub>
- [hike](https://github.com/davep/hike) - A Markdown browser for the terminal. <sub>`Python` · ★ 134</sub>
- [cheznav](https://github.com/djetelina/cheznav) - TUI for chezmoi. <sub>`Python` · ★ 109</sub>
- [pikpaktui](https://github.com/Bengerthelorf/pikpaktui) - A TUI and CLI client for PikPak cloud storage — written in pure Rust. OpenClaw friendly. Browse, download, upload, stream, and manage your files from the terminal. <sub>`Rust` · ★ 107</sub>
...
- [TideFTP](https://github.com/allisonhere/TideFTP) - Terminal file transfer client for SFTP, FTP, and FTPS with a two-pane layout and transfer queue. <sub>`Go` · ★ 10 · [deep dive](https://awesometui.com/tideftp)</sub>
- [dupster](https://github.com/karimz1/dupster) - Dupster - The lazy way to find duplicates in your Terminal. Easily find duplicates, preview them and delete them. For Mac and Linux users. <sub>`Python` · ★ 9 · [deep dive](https://awesometui.com/dupster)</sub>
- [rodeo](https://github.com/lordgreg/rodeo) - Rodeo - a terminal file manager inspired by Norton and Midnight Commander, written in Rust. <sub>`Rust` · ★ 7 · [deep dive](https://awesometui.com/rodeo)</sub>
...
- [sabiql](https://github.com/riii111/sabiql) - Fast, safe-by-design, Vim-first TUI for PostgreSQL, MySQL, and SQLite, built in Rust. <sub>`Rust` · ★ 304</sub>
- [chdig](https://github.com/azat/chdig) - Dig into ClickHouse with TUI interface. <sub>`Rust` · ★ 294</sub>
- [squix](https://github.com/eduardofuncao/squix) - A CLI tool for managing and executing SQL queries across multiple databases. Written in Go, made beautiful with BubbleTea. <sub>`Go` · ★ 267</sub>
- [vi-mongo](https://github.com/kopecmaciej/vi-mongo) - MongoDB TUI manager designed to simplify data visualization and quick manipulation. <sub>`Go` · ★ 242</sub>
- [vi-sql](https://github.com/kopecmaciej/vi-sql) - Terminal UI for SQL databases. <sub>`Go` · ★ 194</sub>
...
- [masume](https://github.com/turanmahmudov/masume) - Terminal database client with AI chat and an MCP server. <sub>`Go` · ★ 72 · [deep dive](https://awesometui.com/masume)</sub>
...
- [lazydb](https://github.com/yelog/lazydb) - Beautiful and convenient TUI database client tool. <sub>`Rust` · ★ 44 · [deep dive](https://awesometui.com/lazydb)</sub>
...
- [play](https://github.com/paololazzari/play) - A TUI playground to experiment with your favorite programs, such as grep, sed, awk, jq and yq. <sub>`Go` · ★ 587</sub>
- [repgrep](https://github.com/acheronfail/repgrep) - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line. <sub>`Rust` · ★ 532</sub>
- [riff](https://github.com/walles/riff) - A syntax highter for diffs, clarifying which parts of lines have changed. <sub>`Rust` · ★ 525</sub>
...
- [regex-tui](https://github.com/vitor-mariano/regex-tui) - A simple TUI to visualize regular expressions right in your terminal. <sub>`Go` · ★ 360</sub>
...
- [docfd](https://github.com/darrenldl/docfd) - TUI multiline fuzzy document finder. <sub>`OCaml` · ★ 289</sub>
...
- [rgx](https://github.com/brevity1swos/rgx) - Regex101 for the terminal — real-time matching, 3 engines, capture groups, replace mode, syntax highlighting, plain-English explanations, undo/redo, mouse support. Written in Rust. <sub>`Rust` · ★ 235</sub>
...
- [diffyml](https://github.com/szhekpisov/diffyml) - A fast, structural YAML diff tool — in a single-dependency binary. <sub>`Go` · ★ 103</sub>
- [regexplain](https://github.com/kapilpokhrel/regexplain) - A terminal UI for explaining and visualizing regular expressions, kindof like regex101. <sub>`Rust` · ★ 96</sub>
...
- [zeit](https://github.com/mrusme/zeit) - Zeit, erfassen. A command line tool for tracking time. (https://tty.fail/mrus/zeit) <sub>`Go` · ★ 588</sub>
...
- [togo](https://github.com/prime-run/togo) - A fast and simple terminal-based task and todo manager built in go. <sub>`Go` · ★ 187</sub>
- [tatuin](https://github.com/panter-dsd/tatuin) - Tatuin (Task Aggregator TUI for N providers) <sub>`Rust` · ★ 139</sub>
- [tudo](https://github.com/jolleyDesign/tudo) - Fast, local, keyboard driven todo list & notebook TUI. <sub>`Rust` · ★ 52</sub>
...
- [herald-mail-app](https://github.com/herald-email/herald-mail-app) - Herald is a terminal email client and inbox cleanup tool with IMAP, AI-assisted triage, MCP tools, and SSH/browser-friendly app modes. <sub>`Go` · ★ 141</sub>
...
- [gloomberb](https://github.com/gloom-sh/gloomberb) - Finance terminal, in your terminal. <sub>`TypeScript` · ★ 2.1k</sub>
...
- [endcord](https://github.com/sparklost/endcord) - The most feature rich Discord TUI client. <sub>`Python` · ★ 988</sub>
...
- [nom](https://github.com/guyfedwards/nom) - RSS reader for the terminal. <sub>`Go` · ★ 744</sub>
...
- [pomo](https://github.com/Bahaaio/pomo) - Customizable TUI Pomodoro timer with ASCII art, progress bar, desktop notifications, and productivity statistics. <sub>`Go` · ★ 504</sub>
...
- [fsel](https://github.com/Mjoyufull/fsel) - Fast TUI app launcher and fuzzy finder for GNU/Linux and BSD. <sub>`Rust` · ★ 420 · [deep dive](https://awesometui.com/fsel)</sub>
- [hours](https://github.com/dhth/hours) - A no-frills time tracking toolkit for command line nerds. <sub>`Go` · ★ 347</sub>
- [toofan](https://github.com/vyrx-dev/toofan) - A minimal, lightning-fast typing TUI for your terminal. <sub>`Go` · ★ 327</sub>
- [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) - A TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions. <sub>`Rust` · ★ 326</sub>
...
- [crona](https://github.com/webxsid/crona) - Local-first work tracking for people who live in the terminal. <sub>`Go` · ★ 41 · [deep dive](https://awesometui.com/crona)</sub>
...
- [tidemail](https://github.com/allisonhere/tidemail) - TUI Key first email client. <sub>`Go` · ★ 37 · [deep dive](https://awesometui.com/tidemail)</sub>
- [soap](https://github.com/GhifariArsa/soap) - The Simple Organisation App in Python. <sub>`Python` · ★ 35</sub>
- [kite-tui](https://github.com/KernelFreeze/kite-tui) - A terminal reader for Kagi News. <sub>`Rust` · ★ 19</sub>
- [tide](https://github.com/allisonhere/tide) - TUI RSS reader with AI summaries. <sub>`Go` · ★ 18 · [deep dive](https://awesometui.com/tide)</sub>
...
- [zonetimeline-tui](https://github.com/findyourexit/zonetimeline-tui) - A terminal tool for visually comparing time zones — built for distributed teams. <sub>`Rust` · ★ 10 · [deep dive](https://awesometui.com/zonetimeline-tui)</sub>
...
- [anoted](https://github.com/gmarinan/anoted) - Local-first meeting recorder and transcriber for the terminal. Linux and Windows. No cloud. <sub>`Go` · ★ 2 · [deep dive](https://awesometui.com/anoted)</sub>
...
- [tui-journal](https://github.com/AmmarAbouZor/tui-journal) - Your journal app if you live in a terminal. <sub>`Rust` · ★ 781</sub>
- [clin-rs](https://github.com/reekta92/clin-rs) - Feature-packed TUI note management app inspired by Obsidian. <sub>`Rust` · ★ 538</sub>
- [rucola](https://github.com/Linus-Mussmaecher/rucola) - Terminal-based markdown note manager. <sub>`Rust` · ★ 537</sub>
...
- [Papr](https://github.com/AfrozSaqlain/Papr) - Papr is a fast terminal-based workspace written in Rust. Get daily new papers in your feed from your field of research, search, discover, and download papers directly from arXiv. <sub>`Rust` · ★ 198 · [deep dive](https://awesometui.com/papr)</sub>
- [glint](https://github.com/ntrospect0/glint) - Terminal TUI-based dashboard, serving at-a-glance information across multiple domains. <sub>`Rust` · ★ 177 · [deep dive](https://awesometui.com/glint)</sub>
...
- [kimun](https://github.com/nico2sh/kimun) - Simple note taking, powerful search, AI ready. <sub>`Rust` · ★ 57 · [deep dive](https://awesometui.com/kimun)</sub>
...
- [treemd](https://github.com/Epistates/treemd) - A (TUI/CLI) markdown navigator with tree-based structural navigation. <sub>`Rust` · ★ 690</sub>
...
- [siggy](https://github.com/johnsideserf/siggy) - Terminal-based Signal messenger client with vim keybindings. <sub>`Rust` · ★ 177</sub>
...
- [spotatui](https://github.com/LargeModGames/spotatui) - A fast, standalone terminal music player in Rust: native Spotify streaming plus local, Subsonic, radio, Qobuz and Youtube sources. <sub>`Rust` · ★ 1.3k</sub>
- [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) - 🪼 Modern music streaming client for the terminal. <sub>`Rust` · ★ 589</sub>
- [ytm-player](https://github.com/peternaame-boop/ytm-player) - YouTube Music TUI client with vim keybindings, synced lyrics, and cross-platform media keys. <sub>`Python` · ★ 504</sub>
- [youtube-music-cli](https://github.com/involvex/youtube-music-cli) - A powerful Terminal User Interface (TUI) music player for YouTube Music. <sub>`TypeScript` · ★ 428</sub>
- [Myx](https://github.com/HaseebKhalid1507/Myx) - Spotify player for the terminal. With reactive themes. <sub>`Rust` · ★ 223</sub>
...
- [vibez](https://github.com/simonepelosi/vibez) - Terminal UI Apple Music player with keyboard controls and full track streaming. <sub>`Go` · ★ 154</sub>
- [rs-pug](https://github.com/JustRoccat/rs-pug) - Blazing fast, terminal music player (TUI) written in Rust. Extensible via Lua plugins, built on Ratatui, MPV, and YT-DLP. Listen to YouTube, SoundCloud, and local files directly from your terminal. <sub>`Rust` · ★ 68 · [deep dive](https://awesometui.com/rs-pug)</sub>
...
- [MovieBox-Tui](https://github.com/mesamirh/MovieBox-Tui) - Terminal interface to find, download, and stream movies, TV shows, and live TV using local media players. <sub>`Rust` · ★ 1.9k</sub>
...
- [lue](https://github.com/paulilaaso/lue) - Terminal eBook Reader with Audiobook-Quality Text-to-Speech — Supports EPUB, PDF, DOCX, HTML, RTF, TXT, and MD. <sub>`Python` · ★ 807</sub>
- [castero](https://github.com/xgi/castero) - TUI podcast client for the terminal. <sub>`Python` · ★ 684</sub>
- [superseedr](https://github.com/Jagalite/superseedr) - A BitTorrent Client in your Terminal. <sub>`Rust` · ★ 657</sub>
- [xytz](https://github.com/xdagiz/xytz) - A Beautiful YouTube Downloader/Player TUI. <sub>`Go` · ★ 639</sub>
- [ytsurf](https://github.com/Stan-breaks/ytsurf) - YouTube in your terminal. Clean and distraction-free. <sub>`Shell` · ★ 602</sub>
...
- [draw](https://github.com/maaslalani/draw) - Draw in your terminal. <sub>`Go` · ★ 547</sub>
...
- [mufetch](https://github.com/ashish0kumar/mufetch) - Neofetch-style music cli. <sub>`Go` · ★ 209</sub>
- [soundscope](https://github.com/bananaofhappiness/soundscope) - A TUI for real-time analysis of audio files, system audio, and microphone input. <sub>`Rust` · ★ 186</sub>
- [theattyr](https://github.com/orhun/theattyr) - A terminal theater for playing VT100 art and animations. <sub>`Rust` · ★ 172</sub>
- [podliner](https://github.com/timkicker/podliner) - Podcasts in any terminal. Fast, clean, offline. <sub>`C#` · ★ 171</sub>
...
- [streamtop](https://github.com/Jorji49/streamtop) - Terminal HLS, DASH, and IPTV stream monitor. Wire probes, TR 101 290, SCTE-35, Prometheus metrics. Rust CLI/TUI. <sub>`Rust` · ★ 103 · [deep dive](https://awesometui.com/streamtop)</sub>
- [Tanko](https://github.com/Alexandro521/Tanko) - Tanko is a tool for reading and downloading manga from the terminal. <sub>`TypeScript` · ★ 85</sub>
...
- [doom-ascii](https://github.com/wojciech-graj/doom-ascii) - DooM in the terminal! <sub>`C` · ★ 881</sub>
- [tetro-tui](https://github.com/Strophox/tetro-tui) - Terminal-based but modern tetromino-stacking game that is customizable and cross-platform. <sub>`Rust` · ★ 755</sub>
- [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) - P2P terminal game about spacepirates playing basketball across the galaxy. <sub>`Rust` · ★ 737</sub>
- [botany](https://github.com/jifunks/botany) - Command line virtual plant buddy. <sub>`Python` · ★ 548</sub>
- [nudoku](https://github.com/jubalh/nudoku) - Ncurses based sudoku game. <sub>`C` · ★ 373</sub>
...
- [dealve-tui](https://github.com/kurama/dealve-tui) - Delve into game deals from your terminal 👾. <sub>`Rust` · ★ 247</sub>
...
- [BalatroTUI](https://github.com/Passeriform/BalatroTUI) - A TUI clone of Balatro, a game by LocalThunk. <sub>`Rust` · ★ 205</sub>
...
- [terminal-space-program](https://github.com/jasonfen/terminal-space-program) - Terminal-native orbital-mechanics rocket simulator. KSP-in-your-terminal, distributed as a single static Go binary. <sub>`Go` · ★ 123</sub>
- [inertia](https://github.com/aclfe/inertia) - A physics sandbox that runs in your terminal: rigid bodies, n-body gravity, cloth, and fluid, projected in 3D onto braille with no GPU. <sub>`Rust` · ★ 118</sub>
...
- [rmcl](https://github.com/objz/rmcl) - A minecraft TUI/CLI launcher written in Rust. <sub>`Rust` · ★ 77</sub>
...
- [tui-2048](https://github.com/ps06756/tui-2048) - A TUI based 2048 game. <sub>`Python` · ★ 7</sub>
...
- [yt-dlp](https://github.com/yt-dlp/yt-dlp) - A feature-rich command-line audio/video downloader. <sub>`Python` · ★ 191k</sub>
- [Mole](https://github.com/tw93/Mole) - 🐹 Clean, uninstall, analyze, optimize, and monitor your Mac. Free open-source CLI, plus a native Mac app. <sub>`Shell` · ★ 67k</sub>
...
- [golazo](https://github.com/0xjuanma/golazo) - The beautiful game in your terminal. Minimal TUI app to keep up with live & recent football/soccer matches written in Go. <sub>`Go` · ★ 860</sub>
...
- [stormy](https://github.com/ashish0kumar/stormy) - Minimal neofetch-style weather cli. <sub>`Go` · ★ 734</sub>
- [scope-tui](https://github.com/alemidev/scope-tui) - Oscilloscope/vectorscope/spectroscope for your terminal. <sub>`Rust` · ★ 717</sub>
...
- [usbtree](https://github.com/gnomeria/usbtree) - Live USB device tree in your terminal. Rust TUI, no root, no libusb. Full activity metrics on Linux; device tree on macOS/Windows. <sub>`Rust` · ★ 653</sub>
- [fnt](https://github.com/alexmyczko/fnt) - Apt for fonts, the missing font manager for macOS/linux. <sub>`Shell` · ★ 638</sub>
- [snowmachine](https://github.com/sontek/snowmachine) - A python script that allows your terminal to snow. <sub>`Python` · ★ 607</sub>
- [qman](https://github.com/plp13/qman) - A more modern man page viewer for our terminals. <sub>`C` · ★ 601</sub>
...
- [linecast](https://github.com/ashuttl/linecast) - Weather, tides, the sun, the moon, and maps, in your terminal. The Old Farmer's Almanac meets Minitel. <sub>`Python` · ★ 464 · [deep dive](https://awesometui.com/linecast)</sub>
- [imgcat](https://github.com/danielgatis/imgcat) - Display images and gifs in your terminal. <sub>`Go` · ★ 416</sub>
...
- [daylight](https://github.com/jbreckmckye/daylight) - A command-line program for tracking sunrise and sunset times. <sub>`Go` · ★ 368</sub>
...
- [steamfetch](https://github.com/unhappychoice/steamfetch) - Neofetch for Steam - Display your Steam stats in terminal. <sub>`Rust` · ★ 198</sub>
...
- [mlbt](https://github.com/mlb-rs/mlbt) - A terminal user interface for the MLB Stats API. Check scores, standings, and stats. Even watch a baseball game in your terminal! ⚾. <sub>`Rust` · ★ 162</sub>
- [ansizalizer](https://github.com/Zebbeni/ansizalizer) - A TUI to convert Images to ANSI strings using bubbletea. <sub>`Go` · ★ 157</sub>
- [gtab](https://github.com/Franvy/gtab) - Save and restore Ghostty terminal tab layouts with a single command — on macOS. <sub>`Rust` · ★ 151</sub>
- [gotz](https://github.com/merschformann/gotz) - CLI timezone info. <sub>`Go` · ★ 149</sub>
- [veet](https://github.com/swadhinbiswas/veet) - Universal Linux Application Uninstaller & Deep-Clean Residual Purger. <sub>`Go` · ★ 148</sub>
...
- [sigye](https://github.com/am2rican5/sigye) - A beautiful terminal clock with ASCII art fonts. <sub>`Rust` · ★ 128</sub>
- [carl](https://github.com/b1rger/carl) - Mirror of https://codeberg.org/birger/carl. <sub>`Rust` · ★ 124</sub>
- [ttymap](https://github.com/Kohei-Wada/ttymap) - Mapscii-inspired Terminal-native scriptable globe. <sub>`Rust` · ★ 123</sub>
...
- [soundwatch](https://github.com/matthart1983/soundwatch) - Read-only audio diagnostics for macOS and Linux, in ten tabs. Why does my audio sound wrong? <sub>`Rust` · ★ 8</sub>
...
Projects with a full deep-dive page on awesometui.com — overview, source-backed install options, keybindings, and screenshots. All 108 are marked **deep dive** throughout this list; here are the most-starred.
...
| [herdr](https://github.com/herdrdev/herdr) | The runtime your coding agents live on. | Rust | 38k | [deep dive](https://awesometui.com/herdr) |
| [llmfit](https://github.com/AlexsJones/llmfit) | Hundreds of models & providers. One command to find what runs on your hardware. | Rust | 36k | [deep dive](https://awesometui.com/llmfit) |
...
<sub>Synced 2026-09-14 10:44 UTC from <a href="https://awesometui.com">awesometui.com</a> · 1,343 projects · Made for people who love the terminal.</sub>

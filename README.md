...
[![Projects](https://img.shields.io/badge/projects-1%2C333-b8860b?style=flat-square)](#contents)
[![Categories](https://img.shields.io/badge/categories-19-3b7dd8?style=flat-square)](#contents)
[![Deep dives](https://img.shields.io/badge/deep_dives-98-8a4fff?style=flat-square)](https://awesometui.com)
[![Updated](https://img.shields.io/badge/synced-2026-09-07-2ea043?style=flat-square)](#how-this-list-is-built)
...
This README is generated from the live catalog at [awesometui.com](https://awesometui.com): **1,333 published projects** across **19 categories** and **12 focused sub-collections**. Every entry is a real GitHub repository that was imported, classified, and reviewed for being an actual terminal UI (not just a CLI). Star counts and languages are synced from GitHub; 98 projects also have a full **deep dive** page with install options, keybindings, and screenshots.
...
- **Development** <sub>(390)</sub>
  - [Development](#development) <sub>(227)</sub> — [API Clients](#api-clients)
  - [Git](#git) <sub>(47)</sub>
...
- **Operate** <sub>(336)</sub>
  - [DevOps](#devops) <sub>(77)</sub> — [Docker & Containers](#docker--containers) · [Kubernetes](#kubernetes)
  - [Monitoring](#monitoring) <sub>(72)</sub> — [System Monitors](#system-monitors) · [Log Viewers](#log-viewers)
  - [Network](#network) <sub>(76)</sub> — [SSH & Remote Access](#ssh--remote-access)
  - [System](#system) <sub>(68)</sub> — [Package Managers](#package-managers)
  - [Security](#security) <sub>(43)</sub>
- **Data & Files** <sub>(173)</sub>
  - [File Management](#file-management) <sub>(86)</sub>
  - [Database Clients](#database-clients) <sub>(28)</sub>
  - [Text Processing](#text-processing) <sub>(59)</sub>
- **Work & Communication** <sub>(140)</sub>
  - [Productivity](#productivity) <sub>(105)</sub> — [Task Managers](#task-managers) · [Email](#email)
  - [Writing & Notes](#writing--notes) <sub>(22)</sub> — [Note-taking](#note-taking)
  - [IRC](#irc) <sub>(13)</sub>
- **Media & Play** <sub>(119)</sub>
...
- [hunk](https://github.com/modem-dev/hunk) - Review-first terminal diff viewer for agentic coders. <sub>`TypeScript` · ★ 9.1k · [deep dive](https://awesometui.com/hunk)</sub>
...
- [concord](https://github.com/chojs23/concord) - A feature-rich TUI client for Discord. <sub>`Rust` · ★ 1.4k · [deep dive](https://awesometui.com/concord)</sub>
...
- [flyline](https://github.com/HalFrgrd/flyline) - Flyline: a Bash plugin to replace readline for a modern line editing experience: syntax highlighting, agent integration, rich prompts, tooltips, fuzzy history search, and more! <sub>`Rust` · ★ 1.2k</sub>
...
- [tlrc](https://github.com/tldr-pages/tlrc) - Official tldr client written in Rust. <sub>`Rust` · ★ 994</sub>
- [oq](https://github.com/plutov/oq) - Terminal OpenAPI Spec viewer. <sub>`Go` · ★ 974</sub>
- [ggh](https://github.com/byawitz/ggh) - Recall your SSH sessions (also search your SSH config file) <sub>`Go` · ★ 953</sub>
- [httpyac](https://github.com/AnWeber/httpyac) - Command Line Interface for .http and .rest files. Connect with http, gRPC, WebSocket and MQTT. <sub>`TypeScript` · ★ 869</sub>
- [has](https://github.com/kdabir/has) - ✅ checks presence of various command line tools and their versions on the path. <sub>`Shell` · ★ 819</sub>
- [halp](https://github.com/orhun/halp) - A CLI tool to get help with CLI tools 🐙. <sub>`Rust` · ★ 766</sub>
- [mani](https://github.com/alajmo/mani) - Robot: CLI tool to help you manage repositories. <sub>`Go` · ★ 761</sub>
...
- [flamelens](https://github.com/YS-L/flamelens) - Flamegraph viewer in the terminal. <sub>`Rust` · ★ 642</sub>
- [nemu](https://github.com/nemuTUI/nemu) - Ncurses UI for QEMU. <sub>`C` · ★ 603</sub>
- [personal-os-setup](https://github.com/AmineDjeghri/personal-os-setup) - An app and guide to easily configure Windows, Linux, MacOS, Google TV, Stremio, Home Assistant and more (including WSL2, GPU drivers & development tools). Improve your UX & productivity. <sub>`Python` · ★ 602</sub>
...
- [octocov](https://github.com/k1LoW/octocov) - Octocov is a toolkit for collecting code metrics (code coverage, code to test ratio, test execution time and your own custom metrics). <sub>`Go` · ★ 508</sub>
...
- [gophertube](https://github.com/KrishnaSSH/gophertube) - A modern terminal user interface for searching and watching YouTube videos using mpv and chafa. <sub>`Go` · ★ 429</sub>
...
- [agent-manager](https://github.com/YoanWai/agent-manager) - The fastest workflow for every AI coding agent. Live status, quick prompts, worktrees, and diff review from one tmux TUI. <sub>`Go` · ★ 396 · [deep dive](https://awesometui.com/agent-manager)</sub>
...
- [lazyjira](https://github.com/textfuel/lazyjira) - Lazygit but for Jira. <sub>`Go` · ★ 360</sub>
- [dra](https://github.com/devmatteini/dra) - A command line tool to download release assets from GitHub. <sub>`Rust` · ★ 355</sub>
- [chiko](https://github.com/felangga/chiko) - The ultimate beauty gRPC Client on your Terminal! <sub>`Go` · ★ 354</sub>
- [epiq](https://github.com/ljtn/epiq) - Distributed, code-native issue tracker - audit workflows via time-travel. <sub>`TypeScript` · ★ 354</sub>
- [pipeform](https://github.com/magodo/pipeform) - Terraform runtime TUI 🫧. <sub>`Go` · ★ 354</sub>
- [mcpsnoop](https://github.com/kerlenton/mcpsnoop) - Wireshark for MCP. A transparent proxy that shows every real tool call between your AI client and your MCP servers, live in your terminal. <sub>`Go` · ★ 347</sub>
...
- [hnterm](https://github.com/ggerganov/hnterm) - Pagewithcurl: Hacker News in the terminal. <sub>`C++` · ★ 321</sub>
- [gaze](https://github.com/wtetsu/gaze) - 👁️Executes commands for you. <sub>`Go` · ★ 316</sub>
- [noodle](https://github.com/wilfredinni/noodle) - A delicious REST client for your terminal. <sub>`TypeScript` · ★ 303 · [deep dive](https://awesometui.com/noodle)</sub>
- [loggo](https://github.com/aurc/loggo) - A powerful terminal app for structured log streaming. <sub>`Go` · ★ 291</sub>
- [try-rs](https://github.com/tassiovirginio/try-rs) - A blazing fast, Rust-based workspace manager for your temporary experiments. <sub>`Rust` · ★ 286</sub>
...
- [dotbins](https://github.com/basnijholt/dotbins) - Keep updated binaries in your dotfiles 🧰. <sub>`Python` · ★ 272</sub>
...
- [typtea](https://github.com/ashish0kumar/typtea) - Minimal terminal typing tester. <sub>`Go` · ★ 243</sub>
- [lazyskills](https://github.com/alvinunreal/lazyskills) - Mission control for agent skills. <sub>`Go` · ★ 242 · [deep dive](https://awesometui.com/lazyskills)</sub>
- [roumon](https://github.com/becheran/roumon) - Universal goroutine monitor using pprof and termui. <sub>`Go` · ★ 237</sub>
- [Livediff](https://github.com/SoCkEt7/Livediff) - ⚡ Livediff: Watch file diffs live in your terminal. Minimalist Rust TUI for instant feedback loops. <sub>`Rust` · ★ 230</sub>
...
- [glab-tui](https://github.com/rcieri/glab-tui) - A terminal user interface (TUI) for GitLab/GitHub, built on top of glab/gh. Browse issues, merge requests, pipelines, runners, and releases without leaving your terminal. Built for personal use. <sub>`Rust` · ★ 221</sub>
...
- [mandible](https://github.com/AS-FOSS/mandible) - A Universal TUI Manual Viewer for CLI Tools in Rust. <sub>`Rust` · ★ 161</sub>
- [Rustlens](https://github.com/yashksaini-coder/Rustlens) - Your Rust codebase, revealed It parses your Rust source files and provides an interactive interface to browse functions, structs, enums, traits, and more — all inside your terminal. <sub>`Rust` · ★ 157</sub>
- [crates-tui](https://github.com/ratatui/crates-tui) - A TUI for exploring crates.io using Ratatui. <sub>`Rust` · ★ 156</sub>
- [oyui](https://github.com/emilien-jegou/oyui) - Modern TUI merge tool and interactive diff editor for Jujutsu (jj) and Git. <sub>`Rust` · ★ 149</sub>
- [stree](https://github.com/orangekame3/stree) - 📁Directory trees of AWS S3 Bucket. <sub>`Go` · ★ 144</sub>
- [mcp-probe](https://github.com/conikeec/mcp-probe) - A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an… <sub>`Rust` · ★ 138</sub>
- [marchat](https://github.com/Cod-e-Codes/marchat) - Terminal chat for developers: Go WebSocket server + Bubble Tea TUI client, optional E2E, reactions, DMs, channels, plugins, files, code snippets, admin UI. Backends: SQLite, PostgreSQL, or MySQL. <sub>`Go` · ★ 135</sub>
- [datui](https://github.com/derekwisong/datui) - Data Exploration in the Terminal. <sub>`Rust` · ★ 133</sub>
- [gwm-cli](https://github.com/kbrdn1/gwm-cli) - Git worktree manager for the terminal: CLI + TUI in Rust. Creates the worktree, runs your project setup, links the issue, and shows which AI agent is working where. Single binary, no git CLI needed. <sub>`Rust` · ★ 132</sub>
- [tttui](https://github.com/ReidoBoss/tttui) - A typing test TUI(Text-based User Interface) previously written in python, now migrated to rust! <sub>`Rust` · ★ 124 · [deep dive](https://awesometui.com/tttui)</sub>
...
- [lexy](https://github.com/antoniorodr/lexy) - Lexy is a lightweight CLI tool that fetches programming tutorials from "Learn X in Y Minutes" directly into your terminal. <sub>`Python` · ★ 122</sub>
- [gitsocial](https://github.com/gitsocial-org/gitsocial) - Cross-forge collaboration platform. <sub>`Go` · ★ 121</sub>
- [amtui](https://github.com/pehlicd/amtui) - Alertmanager TUI - Your Terminal Companion for Alertmanager. <sub>`Go` · ★ 114</sub>
- [dhv](https://github.com/davep/dhv) - Dive into Python code. <sub>`Python` · ★ 103</sub>
- [kyma](https://github.com/museslabs/kyma) - Presentations from markdown in the terminal with fancy transition animations. <sub>`Go` · ★ 98</sub>
...
- [graf](https://github.com/reekta92/graf) - A TUI graph view for markdown files with wikilinks. Customizable. <sub>`Rust` · ★ 81</sub>
- [lazyslurm](https://github.com/hill/lazyslurm) - Like lazygit/lazydocker but for slurm. <sub>`Rust` · ★ 79</sub>
...
- [spectatui](https://github.com/tinesoft/spectatui) - A TUI (Terminal UI) dashboard for Github Spec-Kit. <sub>`Rust` · ★ 77</sub>
- [leetrs](https://github.com/shadowmkj/leetrs) - Leetrs is a blazing-fast, Rust-powered CLI and engine designed to make solving LeetCode problems from the terminal a first-class developer experience. <sub>`Rust` · ★ 75 · [deep dive](https://awesometui.com/leetrs)</sub>
...
- [omp-manager](https://github.com/psmux/omp-manager) - Installation and manager for Oh My Posh! The one thing you need to browse themes, install fonts, and configure shells. <sub>`Rust` · ★ 69</sub>
...
- [octoscope](https://github.com/gfazioli/octoscope) - Terminal dashboard for GitHub — followers, stars, PRs and issues at a glance, auto-refreshed. <sub>`Go` · ★ 64</sub>
...
- [lazyenv](https://github.com/lazynop/lazyenv) - TUI for managing .env files. <sub>`Go` · ★ 61</sub>
...
- [proqi](https://github.com/oborchers/proqi) - A terminal-native prompt composer for power users running multiple coding agents. <sub>`Rust` · ★ 23 · [deep dive](https://awesometui.com/proqi)</sub>
...
- [termdock](https://github.com/padovanl/termdock) - 📟 A terminal multiplexer with persistent sessions, split panes, detach, reattach. Written from scratch in Go. <sub>`Go` · ★ 17 · [deep dive](https://awesometui.com/termdock)</sub>
...
- [revision](https://github.com/bapatchirag/revision) - Lazygit for SVN - a fast, keyboard-driven TUI for SVN. <sub>`Go` · ★ 7 · [deep dive](https://awesometui.com/revision)</sub>
...
- [lazymqtt](https://github.com/ScottFelder/lazymqtt) - Terminal UI MQTT client with features like saved connections, live topic tree, message inspector, and plugins. <sub>`Rust` · ★ 4 · [deep dive](https://awesometui.com/lazymqtt)</sub>
...
- [branchlet](https://github.com/raghavpillai/branchlet) - Branchlet: A simple CLI Git worktree manager. <sub>`TypeScript` · ★ 495</sub>
- [froggit](https://github.com/thewizardshell/froggit) - Simplify your Git workflow with visual feedback, keyboard-driven controls, and a streamlined experience. <sub>`Go` · ★ 485</sub>
...
- [ec](https://github.com/chojs23/ec) - Easy terminal-native 3-way git mergetool vim-like workflow. <sub>`Go` · ★ 295</sub>
- [lazyworktree](https://github.com/chmouel/lazyworktree) - Easy Git worktree management CLI and TUI for the terminal. <sub>`Go` · ★ 290</sub>
...
- [gitnr](https://github.com/reemus-dev/gitnr) - Create .gitignore files using one or more templates from TopTal, GitHub or your own collection. <sub>`Rust` · ★ 237</sub>
- [deadbranch](https://github.com/armgabrielyan/deadbranch) - Clean up stale git branches safely. <sub>`Rust` · ★ 229</sub>
...
- [guitar](https://github.com/asinglebit/guitar) - A terminal based git client with fast topological & chronological graph rendering. <sub>`Rust` · ★ 189</sub>
- [prs](https://github.com/dhth/prs) - Stay updated on PRs from your terminal. <sub>`Go` · ★ 184</sub>
- [gittop](https://github.com/hjr265/gittop) - A beautiful terminal UI for visualizing Git repository statistics, inspired by htop/btop. <sub>`Go` · ★ 155</sub>
- [git-cc](https://github.com/SKalt/git-cc) - A git extension to help write conventional commits. <sub>`Go` · ★ 141</sub>
- [drift](https://github.com/aymanbagabas/drift) - 👾 A git diff pager that actually wants to be looked at. <sub>`Rust` · ★ 131</sub>
- [gitpane](https://github.com/affromero/gitpane) - Multi-repo Git workspace dashboard for the terminal. <sub>`Rust` · ★ 130</sub>
- [git-scope](https://github.com/Bharath-code/git-scope) - A fast TUI to see the status of all git repositories on your machine. <sub>`Go` · ★ 119</sub>
...
- [brows](https://github.com/rubysolo/brows) - CLI GitHub release browser. <sub>`Go` · ★ 84</sub>
- [gitwig](https://github.com/tareqmy/gitwig) - A rust based tui an alternative to sourcetree. <sub>`Rust` · ★ 82</sub>
- [act3](https://github.com/dhth/act3) - Glance at the last 3 runs of your GitHub Actions workflows. <sub>`Go` · ★ 81</sub>
- [differ](https://github.com/JanSmrcka/differ) - Terminal UI git diff viewer with two-panel layout, syntax highlighting, vim keybindings, and AI-powered commits. Built with Go + Bubble Tea. <sub>`Go` · ★ 55</sub>
...
- [manygit](https://github.com/rabeeh-ta/manygit) - A multi-repository Git CLI manager — see what's ahead, behind, or dirty across all of them at once. <sub>`Go` · ★ 8 · [deep dive](https://awesometui.com/manygit)</sub>
...
- [fresh](https://github.com/sinelaw/fresh) - Terminal based IDE & text editor: easy, powerful and fast. <sub>`Rust` · ★ 8.7k</sub>
...
- [ad](https://github.com/sminez/ad) - An adaptable text editor. <sub>`Rust` · ★ 739</sub>
- [moe](https://github.com/fox0430/moe) - A command line based editor inspired by Vim. Written in Nim. <sub>`Nim` · ★ 719</sub>
- [orbiton](https://github.com/xyproto/orbiton) - Snappy and configuration-free text editor/IDE for the terminal. Suitable for writing git commit messages, editing Markdown, config files, source code, man pages and for quick edit-format-compile… <sub>`Go` · ★ 699 · [deep dive](https://awesometui.com/orbiton)</sub>
- [turbo](https://github.com/magiblot/turbo) - An experimental text editor based on Scintilla and Turbo Vision. <sub>`C++` · ★ 679</sub>
- [elinks](https://github.com/rkd77/elinks) - Fork of elinks. <sub>`C` · ★ 632</sub>
- [tilde](https://github.com/gphalkes/tilde) - The Tilde text editor. <sub>`C++` · ★ 552</sub>
- [mdfried](https://github.com/benjajaja/mdfried) - A markdown viewer for the terminal that renders images and Big Headers™. <sub>`Rust` · ★ 507</sub>
- [tut](https://github.com/RasmusLindroth/tut) - TUI for Mastodon with vim inspired keys. <sub>`Go` · ★ 501</sub>
- [dawn](https://github.com/andrewmd5/dawn) - A distraction-free writing environment; draft anything, write now. <sub>`C` · ★ 457</sub>
- [hygg](https://github.com/kruseio/hygg) - 📚 Simplifying the way you read. Minimalistic Vim-like TUI document reader. <sub>`Rust` · ★ 352</sub>
...
- [dte](https://github.com/craigbarnes/dte) - A small, configurable terminal text editor (mirrored from https://gitlab.com/craigbarnes/dte) <sub>`C` · ★ 238</sub>
- [ttt](https://github.com/eugenioenko/ttt) - TTT Editor (Terminal Text Tool): A real alternative to VS Code, Zed, and Sublime that runs in your terminal. A TUI that feels like GUI. Single binary, zero config. <sub>`Go` · ★ 238</sub>
- [emeraldian](https://github.com/iamrohithrnair/emeraldian) - A terminal UI for your Obsidian vault: live-preview notes, backlinks, images, a force-directed graph and an assistant. <sub>`Rust` · ★ 209</sub>
...
- [claws](https://github.com/clawscli/claws) - K9s-inspired TUI for AWS resource management with vim-style navigation. <sub>`Go` · ★ 155</sub>
- [toast](https://github.com/paradise-runner/toast) - A batteries-included, beautiful, in-terminal IDE. <sub>`Go` · ★ 109</sub>
...
- [nino](https://github.com/evanlin96069/nino) - My personal text editor. <sub>`C` · ★ 96</sub>
- [perkins](https://github.com/Mr-Robot-err-404/perkins) - ASCII pixel art editor for the terminal. <sub>`Go` · ★ 93</sub>
- [Alwide](https://github.com/arnauda-gh/Alwide) - The Modern TUI IDE. The intuitive experience in your terminal. <sub>`C` · ★ 85</sub>
...
- [mnml](https://github.com/chris-mclennan/mnml) - A NvChad-style terminal IDE in Rust — vim or standard editing, LSP, git, embedded HTTP/CDP/DAP, AI panes, headless test harness. One binary. <sub>`Rust` · ★ 15 · [deep dive](https://awesometui.com/mnml)</sub>
...
- [pyTermTk](https://github.com/ceccopierangiolieugenio/pyTermTk) - Python Terminal Toolkit - a Spiced Up Cross Compatible TUI Library 🌶️. <sub>`Python` · ★ 913</sub>
...
- [termbox2](https://github.com/termbox/termbox2) - Terminal I/O library. <sub>`C` · ★ 763</sub>
- [php-tui](https://github.com/php-tui/php-tui) - Make awesome console applications in PHP (port of Rust's Ratatui) <sub>`PHP` · ★ 615</sub>
- [nimwave](https://github.com/ansiwave/nimwave) - TUIs for the terminal, desktop, and web. <sub>`Nim` · ★ 547</sub>
- [TermGL](https://github.com/wojciech-graj/TermGL) - 2D & 3D graphics engine in the terminal [C/C++]. <sub>`C` · ★ 408</sub>
- [nocterm](https://github.com/Norbert515/nocterm) - A powerful, Flutter-inspired Terminal User Interface framework for building beautiful command-line applications in Dart. <sub>`Dart` · ★ 399</sub>
- [stickers](https://github.com/76creates/stickers) - Building blocks for charmbracelet/lipgloss 👾. <sub>`Go` · ★ 399</sub>
- [tuibox](https://github.com/Cubified/tuibox) - A single-header terminal UI (TUI) library, capable of creating mouse-driven, interactive applications on the command line. <sub>`C` · ★ 332</sub>
- [ConsoleEx](https://github.com/nickprotop/ConsoleEx) - SharpConsoleUI — A reactive terminal UI framework for .NET with a robust async model, per-window threads, a real compositor engine, 30+ controls, and NativeAOT support. <sub>`C#` · ★ 272</sub>
...
- [tui4j](https://github.com/WilliamAGH/tui4j) - TUI4J: Terminal User Interface library for Java that includes Bubble Tea ported from Go. <sub>`Java` · ★ 121</sub>
...
- [casciian](https://github.com/crramirez/casciian) - Text User Interface Library. <sub>`Java` · ★ 51</sub>
...
- [opencode](https://github.com/anomalyco/opencode) - The open source coding agent. <sub>`TypeScript` · ★ 205k</sub>
- [claude-code](https://github.com/anthropics/claude-code) - Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and handling git workflows… <sub>`Python` · ★ 144k</sub>
...
- [herdr](https://github.com/herdrdev/herdr) - The runtime your coding agents live on. <sub>`Rust` · ★ 36k · [deep dive](https://awesometui.com/herdr)</sub>
...
- [Backlog.md](https://github.com/MrLesk/Backlog.md) - Backlog.md - A tool for managing project collaboration between humans and AI Agents in a git ecosystem. <sub>`TypeScript` · ★ 6.7k</sub>
...
- [pixtuoid](https://github.com/IvanWng97/pixtuoid) - Terminal pixel-art office for AI coding agents. <sub>`Rust` · ★ 471</sub>
- [toktop](https://github.com/htin1/toktop) - Llm usage monitor in terminal. <sub>`Rust` · ★ 173</sub>
...
- [codex](https://github.com/openai/codex) - Lightweight coding agent that runs in your terminal. <sub>`Rust` · ★ 122k</sub>
...
- [VTCode](https://github.com/vinhnx/VTCode) - VT Code is an open-source Rust terminal coding agent. <sub>`Rust` · ★ 832</sub>
...
- [tenere](https://github.com/pythops/tenere) - 🤖 TUI for LLMs. <sub>`Rust` · ★ 682</sub>
- [agentty](https://github.com/1ay1/agentty) - AI pair programming in your terminal — one static binary, sub-ms startup, any model. <sub>`C++` · ★ 603 · [deep dive](https://awesometui.com/agentty)</sub>
...
- [models](https://github.com/reyamira/models) - TUI and CLI for browsing models.dev, benchmarks, coding agents, and statuses for AI providers. <sub>`Rust` · ★ 505</sub>
- [parllama](https://github.com/paulrobello/parllama) - TUI for Ollama and other LLM providers. <sub>`Python` · ★ 487</sub>
- [phi](https://github.com/pulseaiclub/phi) - A coding Agent, rpc plugin, sub-agents, hashline edits, and mcp. <sub>`Go` · ★ 296</sub>
- [ostt](https://github.com/kristoferlund/ostt) - Open source voice-to-text for the terminal. Record from a hotkey, transcribe with any provider, pipe to AI or shell commands. <sub>`Rust` · ★ 294 · [deep dive](https://awesometui.com/ostt)</sub>
- [amux](https://github.com/andyrewlee/amux) - TUI for easily running parallel coding agents. <sub>`Go` · ★ 157</sub>
- [fast-resume](https://github.com/angristan/fast-resume) - Find that one coding agent session you want to get back to! <sub>`Rust` · ★ 156</sub>
...
- [gorae](https://github.com/Han8931/gorae) - A terminal-first knowledge base for PDFs, EPUBs, and Markdown with a built-in AI assistant. <sub>`Go` · ★ 95</sub>
- [Martty](https://github.com/openma-ai/Martty) - Deepseek-harness-tui（dsh-tui） before. Self-Improvement TUI Plugin of DeepSeek Harness. Everything Here Is Also A Plugin. Martty is a ACP client. <sub>`Rust` · ★ 69 · [deep dive](https://awesometui.com/martty)</sub>
...
- [oolong](https://github.com/dicedatalore/oolong) - 🍵 Simple ephemeral chat in your terminal. <sub>`Go` · ★ 20</sub>
...
- [ducker](https://github.com/robertpsoane/ducker) - A slightly quackers Docker TUI based on k9s 🦆. <sub>`Rust` · ★ 926</sub>
- [purple](https://github.com/erickochen/purple) - Free, open-source terminal SSH manager and SSH config editor in Rust for macOS and Linux that keeps ~/.ssh/config in sync with 18 cloud providers, monitors live SSH tunnels and manages Docker and… <sub>`Rust` · ★ 674</sub>
...
- [Pocker](https://github.com/pommee/Pocker) - ~ TUI tool for docker. <sub>`Python` · ★ 190</sub>
...
- [d4s](https://github.com/jr-k/d4s) - 🍊 A fast, keyboard-driven terminal UI to manage Docker containers, Compose stacks, and Swarm services with the ergonomics of K9s. <sub>`Go` · ★ 127</sub>
- [layerx](https://github.com/deveshctl/layerx) - LayerX Image Inspector - open-source terminal explorer for container images. Browse layers, spot wasted bytes, and gate CI on image efficiency. <sub>`Go` · ★ 120</sub>
...
- [e1s](https://github.com/keidarcy/e1s) - E1S - Easily Manage AWS ECS Resources in Terminal(~k9s for ECS) 🐱. <sub>`Go` · ★ 923</sub>
- [lfk](https://github.com/janosmiko/lfk) - ⚡ LFK is a lightning-fast, keyboard-focused, yazi-inspired terminal user interface for navigating and managing Kubernetes clusters. <sub>`Go` · ★ 838 · [deep dive](https://awesometui.com/lfk)</sub>
- [ku](https://github.com/bjarneo/ku) - A fast, keyboard-driven Kubernetes TUI. Browse any resource, edit objects, follow logs, and shell into pods. <sub>`Go` · ★ 545</sub>
- [kl](https://github.com/robinovitch61/kl) - An interactive Kubernetes log viewer for your terminal. <sub>`Go` · ★ 417</sub>
...
- [talos-pilot](https://github.com/Handfish/talos-pilot) - Talos TUI for real-time node monitoring, log streaming, etcd health, and diagnostics. <sub>`Rust` · ★ 244</sub>
...
- [pug](https://github.com/leg100/pug) - Drive terraform at terminal velocity. <sub>`Go` · ★ 700</sub>
- [damon](https://github.com/hashicorp/damon) - A terminal UI (TUI) for HashiCorp Nomad. <sub>`Go` · ★ 488</sub>
- [gama](https://github.com/termkit/gama) - Manage your GitHub Actions from Terminal with great UI 🧪. <sub>`Go` · ★ 484</sub>
- [wander](https://github.com/robinovitch61/wander) - A terminal app/TUI for HashiCorp Nomad. <sub>`Go` · ★ 480</sub>
- [argonaut](https://github.com/darksworm/argonaut) - Keyboard-first terminal UI for Argo CD. Browse apps, scope by clusters/namespaces/projects, stream live resource status, trigger syncs, inspect diffs, and roll back safely — all without leaving your… <sub>`Go` · ★ 444</sub>
- [sofka](https://github.com/nklmilojevic/sofka) - A Kubernetes TUI, reimagined in Rust - built on kube-rs and ratatui, async-first from the ground up. <sub>`Rust` · ★ 407</sub>
...
- [sshelf](https://github.com/max-rh/sshelf) - Fast terminal UI for your SSH hosts: fuzzy-search and connect in two keystrokes, dual-pane SFTP file transfer, and background port forwarding. <sub>`Rust` · ★ 64</sub>
...
- [caps-log](https://github.com/NikolaDucak/caps-log) - A small TUI journaling tool. 📖. <sub>`C++` · ★ 398</sub>
...
- [nv-monitor](https://github.com/wentbackward/nv-monitor) - Lightweight nVidia telemetry and terminal system monitor - built for any architecture - Jetson, GB10, GB200, H100. <sub>`C` · ★ 320</sub>
- [NanoCore](https://github.com/AfaanBilal/NanoCore) - NanoCore 8-bit CPU emulator in Rust. <sub>`Rust` · ★ 293</sub>
- [dashbrew](https://github.com/rasjonell/dashbrew) - TUI dashboard builder that lets you visualize data from scripts and APIs right in your console. <sub>`Go` · ★ 272</sub>
...
- [socktop](https://github.com/jasonwitty/socktop) - A TUI-first remote system monitor. <sub>`Rust` · ★ 189</sub>
...
- [psnet](https://github.com/psmux/psnet) - A beautiful real-time TUI network monitor for Windows PowerShell — built in Rust. <sub>`Rust` · ★ 144</sub>
- [qmassa](https://github.com/ulissesf/qmassa) - Rust tools to monitor GPU stats on Linux. <sub>`Rust` · ★ 108</sub>
...
- [cxgpu](https://github.com/nickprotop/cxgpu) - A multi-vendor GPU monitor for the terminal — NVIDIA and AMD — built on SharpConsoleUI. <sub>`C#` · ★ 14</sub>
- [resmon](https://github.com/pacrox/resmon) - Zero-dependency TUI resource monitor written in LuaJIT, compiled into a single self-contained ELF binary. <sub>`Lua` · ★ 6 · [deep dive](https://awesometui.com/resmon)</sub>
...
- [lazyrsync](https://github.com/westpoint-io/lazyrsync) - 🦀 A friendly terminal UI for rsync, written in Rust. Reusable profiles, an honest dry-run diff, and live progress, even over SSH. <sub>`Rust` · ★ 749 · [deep dive](https://awesometui.com/lazyrsync)</sub>
- [omnyssh](https://github.com/timhartmann7/omnyssh) - A fast, keyboard-driven TUI for managing SSH connections, written in Rust. <sub>`Rust` · ★ 494</sub>
...
- [filessh](https://github.com/JayanAXHF/filessh) - A fast and convenient TUI file browser for remote servers. <sub>`Rust` · ★ 230</sub>
- [ssh-list](https://github.com/akinoiro/ssh-list) - 🧑‍💻 SSH connection manager with a TUI interface. <sub>`Rust` · ★ 220</sub>
- [sshclick](https://github.com/karlot/sshclick) - SSH Config terminal manager based on Python and Click framework with Rich and Textual UI. <sub>`Python` · ★ 187</sub>
...
- [netwatch](https://github.com/matthart1983/netwatch) - Real-time network diagnostics in your terminal. One command, zero config, instant visibility. <sub>`Rust` · ★ 3k</sub>
...
- [godap](https://github.com/Macmod/godap) - A complete terminal user interface (TUI) for LDAP. <sub>`Go` · ★ 978</sub>
- [mqttui](https://github.com/EdJoPaTo/mqttui) - Subscribe to a MQTT topic or publish something quickly from the terminal. <sub>`Rust` · ★ 723</sub>
- [vortix](https://github.com/Harry-kp/vortix) - Terminal UI for WireGuard and OpenVPN with real-time telemetry and leak guarding. <sub>`Rust` · ★ 648</sub>
...
- [xfr](https://github.com/lance0/xfr) - A modern iperf3 alternative with a live TUI, multi-client server, and QUIC support. Built in Rust. <sub>`Rust` · ★ 534</sub>
- [flow](https://github.com/programmersd21/flow) - See ur network breathe. <sub>`Go` · ★ 447</sub>
...
- [netshow](https://github.com/taylorwilsdon/netshow) - Lightweight, performant interactive network connection monitor with friendly service names. <sub>`Python` · ★ 365</sub>
- [network-doctor](https://github.com/heymaikol/network-doctor) - Network Doctor is a cross-platform network troubleshooting TUI that turns interface, DNS, TCP, TLS, HTTP, proxy, and path-MTU checks into one plain-English diagnosis. <sub>`Go` · ★ 358</sub>
- [dnspyre](https://github.com/Tantalor93/dnspyre) - CLI tool for a high QPS DNS benchmark. <sub>`Go` · ★ 329</sub>
- [wifitui](https://github.com/shazow/wifitui) - Fast featureful friendly wifi terminal UI. 🛜✨. <sub>`Go` · ★ 329</sub>
- [netop](https://github.com/ZingerLittleBee/netop) - Network Top -- Help you monitor network traffic with bpf. <sub>`Rust` · ★ 268</sub>
- [unifly](https://github.com/hyperb1iss/unifly) - 🌐 Elegant UniFi network management CLI & TUI - for humans and agents. <sub>`Rust` · ★ 251</sub>
...
- [lsoff](https://github.com/yutat23/lsoff) - CLI / TUI that lists listening TCP/UDP ports. <sub>`Go` · ★ 242 · [deep dive](https://awesometui.com/lsoff)</sub>
...
- [ls-horizons](https://github.com/litescript/ls-horizons) - Terminal UI for visualizing NASA's Deep Space Network in real-time. <sub>`Go` · ★ 82</sub>
...
- [rogallo](https://github.com/davep/rogallo) - A terminal-based client for the small web. <sub>`Python` · ★ 20</sub>
...
- [portop](https://github.com/padovanl/portop) - 🔌 What's really using your ports? htop-style TUI, one keypress to kill it. <sub>`Go` · ★ 4 · [deep dive](https://awesometui.com/portop)</sub>
...
- [topgrade](https://github.com/topgrade-rs/topgrade) - Upgrade all the things. <sub>`Rust` · ★ 4.5k</sub>
- [lazynpm](https://github.com/jesseduffield/lazynpm) - Terminal UI for npm. <sub>`Go` · ★ 861</sub>
- [taproom](https://github.com/hzqtc/taproom) - An interactive TUI for Homebrew. <sub>`Go` · ★ 722</sub>
- [pacseek](https://github.com/moson-mo/pacseek) - A terminal user interface for searching and installing Arch Linux packages. <sub>`Go` · ★ 657</sub>
- [bold-brew](https://github.com/Valkyrie00/bold-brew) - Bold Brew (bbrew) - A Homebrew TUI Manager. <sub>`Go` · ★ 440</sub>
- [aptui](https://github.com/mexirica/aptui) - TUI package manager for APT-based Linux distributions. <sub>`Go` · ★ 416</sub>
- [depsguard](https://github.com/arnica/depsguard) - Harden your package manager configs against supply chain attacks. <sub>`Rust` · ★ 381</sub>
- [stew](https://github.com/marwanhawari/stew) - 🥘 An independent package manager for compiled binaries. <sub>`Go` · ★ 356</sub>
...
- [Pacsea](https://github.com/Firstp1ck/Pacsea) - Fast TUI for searching, inspecting, and queueing pacman/AUR packages. <sub>`Rust` · ★ 295</sub>
- [cargo-seek](https://github.com/tareqimbasher/cargo-seek) - A terminal user interface for searching, adding and installing cargo crates. <sub>`Rust` · ★ 198</sub>
- [malt](https://github.com/indaco/malt) - Homebrew's whole ecosystem, none of its weight - a single Zig binary with native postinstall and a themeable TUI & CLI. <sub>`Zig` · ★ 164</sub>
...
- [syswatch](https://github.com/matthart1983/syswatch) - Single-host system diagnostics TUI. Sibling to netwatch. Twelve tabs, plain-English insights, session scrubber. macOS + Linux. <sub>`Rust` · ★ 849</sub>
- [pvetui](https://github.com/devnullvoid/pvetui) - Terminal UI for Proxmox VE. <sub>`Go` · ★ 719</sub>
- [jolt](https://github.com/jordond/jolt) - ⚡️A terminal-based battery and energy monitor for macOS and Linux. <sub>`Rust` · ★ 551</sub>
...
- [framework-tool-tui](https://github.com/grouzen/framework-tool-tui) - A TUI for controlling and monitoring Framework Computers hardware built in Rust. <sub>`Rust` · ★ 355</sub>
- [rura](https://github.com/tlipinski/rura) - Terminal UI for building shell pipelines. <sub>`Rust` · ★ 333 · [deep dive](https://awesometui.com/rura)</sub>
...
- [pstop](https://github.com/psmux/pstop) - Htop for Windows . TUI system monitor with per-core CPU bars, memory/swap/network, tree view, process kill, 7 color schemes, mouse support. cargo install pstop. <sub>`Rust` · ★ 245</sub>
...
- [diskwatch](https://github.com/matthart1983/diskwatch) - Single-host, read-only disk diagnostics TUI. Sibling to netwatch and syswatch. <sub>`Rust` · ★ 208</sub>
- [cheatshh](https://github.com/AnirudhG07/cheatshh) - Cheatshh is a CLI tool to store commands and their descriptions in a place you can look into as cheatshheat so you dont have to remember them. <sub>`Shell` · ★ 192</sub>
- [tray-tui](https://github.com/Levizor/tray-tui) - System tray in your terminal. <sub>`Rust` · ★ 165</sub>
...
- [CrunchyCleaner](https://github.com/Knuspii/CrunchyCleaner) - 💾🧹 A lightweight, software cache cleanup tool for Windows & Linux. <sub>`Go` · ★ 154</sub>
...
- [exosphere](https://github.com/mrdaemon/exosphere) - A simple CLI and TUI driven application that offers patch reporting for remote unix systems, written in Python. <sub>`Python` · ★ 142</sub>
...
- [tufw](https://github.com/peltho/tufw) - Terminal UI for ufw. <sub>`Go` · ★ 863</sub>
- [flawz](https://github.com/orhun/flawz) - A Terminal UI for browsing security vulnerabilities (CVEs) <sub>`Rust` · ★ 606</sub>
- [cotp](https://github.com/replydev/cotp) - Encrypted, command-line TOTP/HOTP authenticator app with import functionality. <sub>`Rust` · ★ 383</sub>
- [bitchat-tui](https://github.com/vaibhav-mattoo/bitchat-tui) - 🔒 Secure, anonymous, peer-to-peer (P2P) Bluetooth chat in your terminal. An off-grid, encrypted TUI messenger built with Rust. <sub>`Rust` · ★ 374</sub>
- [jwt-ui](https://github.com/jwt-rs/jwt-ui) - A command line UI for decoding/encoding JSON Web Tokens. <sub>`Rust` · ★ 350</sub>
...
- [pillager](https://github.com/brittonhayes/pillager) - Pillage filesystems for sensitive information with Go 🔍. <sub>`Go` · ★ 316</sub>
...
- [apw](https://github.com/bendews/apw) - A CLI for Apple Passwords (also known as iCloud Keychain) <sub>`TypeScript` · ★ 238</sub>
...
- [passepartui](https://github.com/kardwen/passepartui) - A TUI for pass. <sub>`Rust` · ★ 129</sub>
- [pass-cli](https://github.com/reyamira/pass-cli) - A secure, cross-platform, always-free, and open-source alternative to 1password, bitwarden, etc., Password and API key manager for folks who live in the command line. (CLI + TUI) <sub>`Go` · ★ 105</sub>
- [ThreatDeck](https://github.com/gripebomb/ThreatDeck) - Terminal-based threat intelligence monitoring and alerting platform. <sub>`Rust` · ★ 105</sub>
...
- [keyward](https://github.com/gateway-of-last-resort/keyward) - Terminal UI to manage SSH keys, edit ~/.ssh/config, and audit your SSH security. Encrypted metadata + backups, an A–F security grade, byte-identical config editing. <sub>`Go` · ★ 46 · [deep dive](https://awesometui.com/keyward)</sub>
...
- [jaiba](https://github.com/rama-oi/jaiba) - Terminal password manager for KeePass vaults. <sub>`Rust` · ★ 20 · [deep dive](https://awesometui.com/jaiba)</sub>
...
- [mc](https://github.com/MidnightCommander/mc) - Midnight Commander's repository. <sub>`C` · ★ 970</sub>
- [pls](https://github.com/pls-rs/pls) - Pls is a prettier and powerful ls(1) for the pros. <sub>`Rust` · ★ 965</sub>
- [elio](https://github.com/elio-fm/elio) - Snappy, batteries-included terminal file manager with rich previews, inline images, bulk actions, and trash support. <sub>`Rust` · ★ 856</sub>
...
- [parallel-disk-usage](https://github.com/KSXGitHub/parallel-disk-usage) - Highly parallelized, blazing fast directory tree analyzer. <sub>`Rust` · ★ 725</sub>
- [nomino](https://github.com/yaa110/nomino) - Batch rename utility for developers. <sub>`Rust` · ★ 709</sub>
- [parqeye](https://github.com/kaushiksrini/parqeye) - Peek inside Parquet files right from your terminal. <sub>`Rust` · ★ 677</sub>
- [browsr](https://github.com/juftin/browsr) - 🗂️ a pleasant file explorer in your terminal supporting all filesystems. <sub>`Python` · ★ 646</sub>
...
- [projectable](https://github.com/dzfrias/projectable) - Dizzy: A TUI file manager built for projects. <sub>`Rust` · ★ 461</sub>
- [mac-cleanup-go](https://github.com/2ykwang/mac-cleanup-go) - TUI macOS cleaner that scans caches/logs, shows sizes/paths, lets you select what to delete before Trash. <sub>`Go` · ★ 459</sub>
- [tran](https://github.com/abdfnx/tran) - 🖥 Securely transfer and send anything between computers with TUI. <sub>`Go` · ★ 447</sub>
- [rovr](https://github.com/NSPC911/rovr) - A stylish, batteries-included terminal file manager. <sub>`Python` · ★ 409</sub>
- [goful](https://github.com/anmitsu/goful) - Goful is a CUI file manager written in Go. <sub>`Go` · ★ 380</sub>
- [dskDitto](https://github.com/jdefrancesco/dskDitto) - Ultra fast and easy duplicate file finder. Awesome TUI/GUI to manage results. <sub>`Go` · ★ 379</sub>
- [dotstate](https://github.com/serkanyersen/dotstate) - A modern, secure, and user-friendly dotfile manager built with Rust. <sub>`Rust` · ★ 374</sub>
...
- [hazelnut](https://github.com/ricardodantas/hazelnut) - 🌰 Terminal-based automated file organizer inspired by Hazel. Watch folders and organize files with rules. <sub>`Rust` · ★ 296</sub>
...
- [rwx](https://github.com/vncsmnl/rwx) - 🦀 An interactive Unix file permissions and ownership TUI manager built in Rust with Ratatui and crossterm. <sub>`Rust` · ★ 192</sub>
...
- [cull](https://github.com/legostin/cull) - Interactive TUI disk space analyzer. <sub>`Go` · ★ 160</sub>
- [redu](https://github.com/drdo/redu) - Ncdu for your restic repository. <sub>`Rust` · ★ 152</sub>
...
- [cheznav](https://github.com/djetelina/cheznav) - TUI for chezmoi. <sub>`Python` · ★ 110</sub>
...
- [pikpaktui](https://github.com/Bengerthelorf/pikpaktui) - A TUI and CLI client for PikPak cloud storage — written in pure Rust. OpenClaw friendly. Browse, download, upload, stream, and manage your files from the terminal. <sub>`Rust` · ★ 102</sub>
...
- [renux](https://github.com/andrianllmm/renux) - A terminal-based bulk file renamer with a TUI. <sub>`Python` · ★ 69</sub>
- [mcdu](https://github.com/mikalv/mcdu) - "ncdu" + "ccleaner" for linux/macos in TUI. <sub>`Rust` · ★ 65</sub>
...
- [diskbloom](https://github.com/Zingzy/diskbloom) - 🌸 a pastel treemap TUI that shows what's eating your disk. <sub>`Go` · ★ 42</sub>
...
- [LibreCommander](https://github.com/leszek3737/LibreCommander) - Modern dual-panel MC for Norton/MC muscle memory in one offline Rust binary — no async runtime, forbid(unsafe), zip-safe archives. <sub>`Rust` · ★ 11</sub>
...
- [go-qo](https://github.com/kiki-ki/go-qo) - Qo is an interactive TUI to query JSON and CSV using SQL. <sub>`Go` · ★ 398</sub>
- [sabiql](https://github.com/riii111/sabiql) - Fast, safe-by-design, Vim-first TUI for PostgreSQL, MySQL, and SQLite, built in Rust. <sub>`Rust` · ★ 300</sub>
...
- [vi-mongo](https://github.com/kopecmaciej/vi-mongo) - MongoDB TUI manager designed to simplify data visualization and quick manipulation. <sub>`Go` · ★ 240</sub>
- [vi-sql](https://github.com/kopecmaciej/vi-sql) - Terminal UI for SQL databases. <sub>`Go` · ★ 193</sub>
...
- [dbcls](https://github.com/Sets88/dbcls) - DbCls is a powerful terminal database client that supports various databases. <sub>`Python` · ★ 46</sub>
...
- [masume](https://github.com/turanmahmudov/masume) - A database client for the terminal. Open a database, read it, and give an agent the same catalog. <sub>`Go` · ★ 5 · [deep dive](https://awesometui.com/masume)</sub>
...
- [miller](https://github.com/johnkerl/miller) - Miller is like awk, sed, cut, join, and sort for name-indexed data such as CSV, TSV, and tabular JSON. <sub>★ 10k</sub>
...
- [srgn](https://github.com/alexpovel/srgn) - A grep-like tool which understands source code syntax and allows for manipulation in addition to search. <sub>`Rust` · ★ 911</sub>
...
- [igrep](https://github.com/konradsz/igrep) - Interactive Grep. <sub>`Rust` · ★ 844</sub>
...
- [play](https://github.com/paololazzari/play) - A TUI playground to experiment with your favorite programs, such as grep, sed, awk, jq and yq. <sub>`Go` · ★ 586</sub>
- [repgrep](https://github.com/acheronfail/repgrep) - An interactive replacer for ripgrep that makes it easy to find and replace across files on the command line. <sub>`Rust` · ★ 530</sub>
...
- [nothing-less](https://github.com/mpryor/nothing-less) - A TUI pager with advanced support for tabular data, inferring/swapping delimiters, and real-time event parsing. <sub>`Python` · ★ 279</sub>
- [rgx](https://github.com/brevity1swos/rgx) - Regex101 for the terminal — real-time matching, 3 engines, capture groups, replace mode, syntax highlighting, plain-English explanations, undo/redo, mouse support. Written in Rust. <sub>`Rust` · ★ 234</sub>
...
- [diffyml](https://github.com/szhekpisov/diffyml) - A fast, structural YAML diff tool — in a single-dependency binary. <sub>`Go` · ★ 97</sub>
...
- [taskdog](https://github.com/Kohei-Wada/taskdog) - Terminal task manager with intelligent schedule optimization.Keyboard-only. No dragging, no micromanagement. <sub>`Python` · ★ 352 · [deep dive](https://awesometui.com/taskdog)</sub>
- [omm](https://github.com/dhth/omm) - On-my-mind: a keyboard-driven task manager for the command line. <sub>`Go` · ★ 331</sub>
- [kanban-tui](https://github.com/Zaloog/kanban-tui) - Task Manager with a TUI written in Python and usable by agents. <sub>`Python` · ★ 280</sub>
...
- [tiki](https://github.com/boolean-maybe/tiki) - Terminal Markdown-based shapeless workflow builder. <sub>`Go` · ★ 206</sub>
- [togo](https://github.com/prime-run/togo) - A fast and simple terminal-based task and todo manager built in go. <sub>`Go` · ★ 186</sub>
- [tatuin](https://github.com/panter-dsd/tatuin) - Tatuin (Task Aggregator TUI for N providers) <sub>`Rust` · ★ 137</sub>
- [tudo](https://github.com/jolleyDesign/tudo) - Fast, local, keyboard driven todo list & notebook TUI. <sub>`Rust` · ★ 48</sub>
- [mach](https://github.com/Q1CHENL/mach) - A terminal-first task manager for people who live in the shell and work with agents. <sub>`Rust` · ★ 22</sub>
...
- [himalaya](https://github.com/pimalaya/himalaya) - CLI to manage emails. <sub>`Rust` · ★ 7.2k</sub>
...
- [herald-mail-app](https://github.com/herald-email/herald-mail-app) - Herald is a terminal email client and inbox cleanup tool with IMAP, AI-assisted triage, MCP tools, and SSH/browser-friendly app modes. <sub>`Go` · ★ 138</sub>
- [mxr](https://github.com/planetaryescape/mxr) - Local-first, keyboard-native terminal email client. <sub>`Rust` · ★ 72</sub>
...
- [endcord](https://github.com/sparklost/endcord) - The most feature rich Discord TUI client. <sub>`Python` · ★ 978</sub>
...
- [zulip-terminal](https://github.com/zulip/zulip-terminal) - Official Zulip terminal client. <sub>`Python` · ★ 863</sub>
- [nom](https://github.com/guyfedwards/nom) - RSS reader for the terminal. <sub>`Go` · ★ 743</sub>
...
- [pomo](https://github.com/Bahaaio/pomo) - Customizable TUI Pomodoro timer with ASCII art, progress bar, desktop notifications, and productivity statistics. <sub>`Go` · ★ 494</sub>
- [clipboard-history](https://github.com/SUPERCILEX/clipboard-history) - Ringboard—the clipboard manager for Linux. <sub>`Rust` · ★ 486</sub>
- [tock](https://github.com/kriuchkov/tock) - Tock is a powerful time tracking tool for the command line. It saves activity logs as plaintext files and provides an interactive terminal UI for viewing your time. <sub>`Go` · ★ 477</sub>
- [fsel](https://github.com/Mjoyufull/fsel) - Fast TUI app launcher for GNU/Linux and BSD. <sub>`Rust` · ★ 417 · [deep dive](https://awesometui.com/fsel)</sub>
- [hours](https://github.com/dhth/hours) - A no-frills time tracking toolkit for command line nerds. <sub>`Go` · ★ 346</sub>
- [toofan](https://github.com/vyrx-dev/toofan) - A minimal, lightning-fast typing TUI for your terminal. <sub>`Go` · ★ 323</sub>
...
- [budget-tracker-tui](https://github.com/Feromond/budget-tracker-tui) - A TUI budget tracker app built in rust. Designed to track income and expenses and help visualize and gather basic insights from your transactions. <sub>`Rust` · ★ 274</sub>
...
- [bmm](https://github.com/dhth/bmm) - Get to your bookmarks in a flash. <sub>`Rust` · ★ 238</sub>
...
- [braindrop](https://github.com/davep/braindrop) - A terminal-based client for raindrop.io. <sub>`Python` · ★ 167</sub>
- [snipt](https://github.com/snipt/snipt) - Snipt is a powerful text snippet expansion tool! <sub>`Rust` · ★ 149</sub>
- [tukai](https://github.com/hlsxx/tukai) - The app provides an interactive typing experience with switchable templates, designed to help users improve their typing speed and accuracy. <sub>`Rust` · ★ 142</sub>
- [goki](https://github.com/abeleinin/goki) - Anki-like flashcard management tool for the terminal! <sub>`Go` · ★ 141</sub>
- [judo](https://github.com/giacomopiccinini/judo) - Multi-database TUI and CLI for ToDo lists. <sub>`Rust` · ★ 118</sub>
...
- [octotype](https://github.com/mahlquistj/octotype) - A WIP TUI typing trainer inspired by monkeytype with a focus on customization. <sub>`Rust` · ★ 101</sub>
...
- [pdf-cli](https://github.com/Yujonpradhananga/pdf-cli) - This is a lightweight, fast and responsive terminal PDF/EPUB viewer with image support on supported terminals. Built with the kitty terminal in mind. <sub>`Go` · ★ 75</sub>
...
- [crona](https://github.com/webxsid/crona) - Local-first work tracking for people who live in the terminal. <sub>`Go` · ★ 32 · [deep dive](https://awesometui.com/crona)</sub>
...
- [zonetimeline-tui](https://github.com/findyourexit/zonetimeline-tui) - A terminal tool for visually comparing time zones — built for distributed teams. <sub>`Rust` · ★ 6 · [deep dive](https://awesometui.com/zonetimeline-tui)</sub>
- [anoted](https://github.com/gmarinan/anoted) - Local-first meeting recorder and transcriber for the terminal. Linux and Windows. No cloud. <sub>`Go` · ★ 1 · [deep dive](https://awesometui.com/anoted)</sub>
...
- [tui-journal](https://github.com/AmmarAbouZor/tui-journal) - Your journal app if you live in a terminal. <sub>`Rust` · ★ 778</sub>
- [rucola](https://github.com/Linus-Mussmaecher/rucola) - Terminal-based markdown note manager. <sub>`Rust` · ★ 531</sub>
- [clin-rs](https://github.com/reekta92/clin-rs) - Feature-packed TUI note management app inspired by Obsidian. <sub>`Rust` · ★ 530</sub>
...
- [Papr](https://github.com/AfrozSaqlain/Papr) - Papr is a fast terminal-based workspace written in Rust. Get daily new papers in your feed from your field of research, search, discover, and download papers directly from arXiv. <sub>`Rust` · ★ 196 · [deep dive](https://awesometui.com/papr)</sub>
...
- [YapPad](https://github.com/A-Knee09/YapPad) - A TUI Note/Journal making app with image rendering and theming :D. <sub>`Go` · ★ 72 · [deep dive](https://awesometui.com/yappad)</sub>
- [redthread](https://github.com/B33pBeeps/redthread) - A sticky-note pegboard TUI for your terminal — drag notes around an ASCII corkboard, dangle red strings between them, switch through named boards. Mouse-first, written in Go. <sub>`Go` · ★ 67</sub>
...
- [treemd](https://github.com/Epistates/treemd) - A (TUI/CLI) markdown navigator with tree-based structural navigation. <sub>`Rust` · ★ 689</sub>
...
- [kirc](https://github.com/mcpcpc/kirc) - Lightweight terminal IRC client. <sub>`C` · ★ 545</sub>
- [zuse](https://github.com/babycommando/zuse) - ZUSE is an irc client for the terminal made in Go with Bubbletea. <sub>`Go` · ★ 324</sub>
- [siggy](https://github.com/johnsideserf/siggy) - Terminal-based Signal messenger client with vim keybindings. <sub>`Rust` · ★ 173</sub>
...
- [cliamp](https://github.com/bjarneo/cliamp) - Cliamp - Terminal music player inspired by winamp. <sub>`Go` · ★ 4k · [deep dive](https://awesometui.com/cliamp)</sub>
...
- [jellyfin-tui](https://github.com/dhonus/jellyfin-tui) - 🪼 Modern music streaming client for the terminal. <sub>`Rust` · ★ 586</sub>
- [ytm-player](https://github.com/peternaame-boop/ytm-player) - YouTube Music TUI client with vim keybindings, synced lyrics, and cross-platform media keys. <sub>`Python` · ★ 496</sub>
- [youtube-music-cli](https://github.com/involvex/youtube-music-cli) - A powerful Terminal User Interface (TUI) music player for YouTube Music. <sub>`TypeScript` · ★ 423</sub>
- [gomu](https://github.com/raziman18/gomu) - Golang TUI music player. <sub>`Go` · ★ 212</sub>
- [Myx](https://github.com/HaseebKhalid1507/Myx) - Spotify player for the terminal. With reactive themes. <sub>`Rust` · ★ 212</sub>
- [waves](https://github.com/llehouerou/waves) - Terminal music player with Soulseek integration, MusicBrainz tagging, Last.fm scrobbling, and radio mode. Built with Go and Bubble Tea. <sub>`Go` · ★ 173</sub>
- [vibez](https://github.com/simonepelosi/vibez) - Terminal UI Apple Music player with keyboard controls and full track streaming. <sub>`Go` · ★ 150</sub>
...
- [ctune](https://github.com/An7ar35/ctune) - NCurses internet radio player for Linux. <sub>`C` · ★ 31</sub>
...
- [MovieBox-Tui](https://github.com/mesamirh/MovieBox-Tui) - Terminal interface to find, download, and stream movies, TV shows, and live TV using local media players. <sub>`Rust` · ★ 1.5k</sub>
...
- [bookokrat](https://github.com/bugzmanov/bookokrat) - A terminal EPUB / PDF Book Reader (+djvu) <sub>`Rust` · ★ 1.1k</sub>
...
- [eilmeldung](https://github.com/christo-auer/eilmeldung) - Eilmeldung is a TUI RSS reader based on the awesome news-flash library. <sub>`Rust` · ★ 992 · [deep dive](https://awesometui.com/eilmeldung)</sub>
- [reddix](https://github.com/ck-zhang/reddix) - Reddix – Reddit, refined for the terminal. <sub>`Rust` · ★ 965</sub>
- [lazycut](https://github.com/ozemin/lazycut) - A simple terminal UI for video trimming. <sub>`Go` · ★ 879</sub>
- [lue](https://github.com/paulilaaso/lue) - Terminal eBook Reader with Audiobook-Quality Text-to-Speech — Supports EPUB, PDF, DOCX, HTML, RTF, TXT, and MD. <sub>`Python` · ★ 806</sub>
- [castero](https://github.com/xgi/castero) - TUI podcast client for the terminal. <sub>`Python` · ★ 684</sub>
- [superseedr](https://github.com/Jagalite/superseedr) - A BitTorrent Client in your Terminal. <sub>`Rust` · ★ 656</sub>
- [xytz](https://github.com/xdagiz/xytz) - A Beautiful YouTube Downloader/Player TUI. <sub>`Go` · ★ 626</sub>
- [ytsurf](https://github.com/Stan-breaks/ytsurf) - YouTube in your terminal. Clean and distraction-free. <sub>`Shell` · ★ 598</sub>
...
- [tewi](https://github.com/anlar/tewi) - Text-based interface for BitTorrent clients (Transmission, qBittorrent, Deluge) <sub>`Python` · ★ 163</sub>
- [bbcli](https://github.com/hako/bbcli) - Newspaper: Browse BBC News like a hacker. <sub>`Rust` · ★ 142</sub>
- [streamtop](https://github.com/Jorji49/streamtop) - Terminal HLS, DASH, and IPTV stream monitor. Wire probes, TR 101 290, SCTE-35, Prometheus metrics. Rust CLI/TUI. <sub>`Rust` · ★ 88 · [deep dive](https://awesometui.com/streamtop)</sub>
- [anilist-tui](https://github.com/pndpti/anilist-tui) - Terminal Interface for the AniList API. <sub>`Python` · ★ 84</sub>
- [Tanko](https://github.com/Alexandro521/Tanko) - Tanko is a tool for reading and downloading manga from the terminal. <sub>`TypeScript` · ★ 82</sub>
...
- [climp](https://github.com/olivier-w/climp) - Cli media player. <sub>`Go` · ★ 43</sub>
...
- [halpradio](https://github.com/halpworld/halpradio) - 📻 LazyVim-inspired Terminal Internet Radio Streamer built with Go & Bubble Tea. 30,000+ stations, beat-reactive animal DJ visualizers, live ICY metadata, and zero-dependency audio. <sub>`Go` · ★ 6 · [deep dive](https://awesometui.com/halpradio)</sub>
- [rav](https://github.com/i-am-logger/rav) - Rust audio visualiser — a real-time spectrum analyser with bars, peak caps and an oscilloscope, in truecolour. <sub>`Rust` · ★ 5</sub>
...
- [doom-ascii](https://github.com/wojciech-graj/doom-ascii) - DooM in the terminal! <sub>`C` · ★ 879</sub>
- [tetro-tui](https://github.com/Strophox/tetro-tui) - Terminal-based but modern tetromino-stacking game that is customizable and cross-platform. <sub>`Rust` · ★ 752</sub>
- [rebels-in-the-sky](https://github.com/ricott1/rebels-in-the-sky) - P2P terminal game about spacepirates playing basketball across the galaxy. <sub>`Rust` · ★ 734</sub>
...
- [tty-solitaire](https://github.com/mpereira/tty-solitaire) - Play solitaire in your terminal! <sub>`C` · ★ 360</sub>
- [bastet](https://github.com/fph/bastet) - Evil falling block game. http://fph.altervista.org/prog/bastet.html. <sub>`C++` · ★ 318</sub>
- [dealve-tui](https://github.com/kurama/dealve-tui) - Delve into game deals from your terminal 👾. <sub>`Rust` · ★ 246</sub>
...
- [terminal-space-program](https://github.com/jasonfen/terminal-space-program) - Terminal-native orbital-mechanics rocket simulator. KSP-in-your-terminal, distributed as a single static Go binary. <sub>`Go` · ★ 118</sub>
- [inertia](https://github.com/aclfe/inertia) - A physics sandbox that runs in your terminal: rigid bodies, n-body gravity, cloth, and fluid, projected in 3D onto braille with no GPU. <sub>`Rust` · ★ 116</sub>
...
- [rmcl](https://github.com/objz/rmcl) - A minecraft TUI/CLI launcher written in Rust. <sub>`Rust` · ★ 76</sub>
...
- [blackguard](https://github.com/ElnurBDa/blackguard) - A beautiful terminal implementation of Scoundrel - the single-player rogue­like card game by Zach Gage and Kurt Bieg - built in Rust with ratatui. <sub>`Rust` · ★ 7</sub>
...
- [yt-dlp](https://github.com/yt-dlp/yt-dlp) - A feature-rich command-line audio/video downloader. <sub>`Python` · ★ 189k</sub>
- [Mole](https://github.com/tw93/Mole) - 🐹 Clean, uninstall, analyze, optimize, and monitor your Mac. Free open-source CLI, plus a native Mac app. <sub>`Shell` · ★ 66k</sub>
...
- [tz](https://github.com/oz/tz) - 🌐 A time zone helper. <sub>`Go` · ★ 899</sub>
- [golazo](https://github.com/0xjuanma/golazo) - The beautiful game in your terminal. Minimal TUI app to keep up with live & recent football/soccer matches written in Go. <sub>`Go` · ★ 855</sub>
- [bttf](https://github.com/BurntSushi/bttf) - A command line tool for datetime arithmetic, parsing, formatting and more. <sub>`Rust` · ★ 767</sub>
- [stormy](https://github.com/ashish0kumar/stormy) - Minimal neofetch-style weather cli. <sub>`Go` · ★ 735</sub>
- [scope-tui](https://github.com/alemidev/scope-tui) - Oscilloscope/vectorscope/spectroscope for your terminal. <sub>`Rust` · ★ 710</sub>
- [bcal](https://github.com/jarun/bcal) - 1234: Bits, bytes and general-purpose calculator. <sub>`C` · ★ 700</sub>
...
- [usbtree](https://github.com/gnomeria/usbtree) - Live USB device tree in your terminal. Rust TUI, no root, no libusb. Full activity metrics on Linux; device tree on macOS/Windows. <sub>`Rust` · ★ 649</sub>
...
- [qman](https://github.com/plp13/qman) - A more modern man page viewer for our terminals. <sub>`C` · ★ 599</sub>
- [pik](https://github.com/jacek-kurlit/pik) - Process Interactive Kill. <sub>`Rust` · ★ 571</sub>
...
- [linecast](https://github.com/ashuttl/linecast) - Weather, tides, the sun, the moon, and maps, in your terminal. The Old Farmer's Almanac meets Minitel. <sub>`Python` · ★ 423 · [deep dive](https://awesometui.com/linecast)</sub>
- [imgcat](https://github.com/danielgatis/imgcat) - Display images and gifs in your terminal. <sub>`Go` · ★ 414</sub>
...
- [tracker](https://github.com/ShenMian/tracker) - A terminal-based real-time satellite tracking and orbit prediction application. <sub>`Rust` · ★ 316</sub>
...
- [numr](https://github.com/nasedkinpv/numr) - Natural-language text calculator with TUI/CLI: variables, units, currencies, and live exchange rates. <sub>`Rust` · ★ 266 · [deep dive](https://awesometui.com/numr)</sub>
- [moji](https://github.com/Microck/moji) - Find and download fonts from the terminal. <sub>`Go` · ★ 246</sub>
...
- [chmod-cli](https://github.com/Mayowa-Ojo/chmod-cli) - Effortlessly generate chmod commands. <sub>`Go` · ★ 199</sub>
- [steamfetch](https://github.com/unhappychoice/steamfetch) - Neofetch for Steam - Display your Steam stats in terminal. <sub>`Rust` · ★ 197</sub>
...
- [mlbt](https://github.com/mlb-rs/mlbt) - A terminal user interface for the MLB Stats API. Check scores, standings, and stats. Even watch a baseball game in your terminal! ⚾. <sub>`Rust` · ★ 161</sub>
- [ansizalizer](https://github.com/Zebbeni/ansizalizer) - A TUI to convert Images to ANSI strings using bubbletea. <sub>`Go` · ★ 156</sub>
- [gotz](https://github.com/merschformann/gotz) - CLI timezone info. <sub>`Go` · ★ 149</sub>
- [gtab](https://github.com/Franvy/gtab) - Save and restore Ghostty terminal tab layouts with a single command — on macOS. <sub>`Rust` · ★ 147</sub>
- [pathos](https://github.com/chip/pathos) - Pathos - CLI for editing a PATH env variable. <sub>`Go` · ★ 145</sub>
- [oh-my-reddit](https://github.com/renatoworks/oh-my-reddit) - Beautiful Reddit threads, live in your terminal. <sub>`Go` · ★ 144</sub>
- [veet](https://github.com/swadhinbiswas/veet) - Universal Linux Application Uninstaller & Deep-Clean Residual Purger. <sub>`Go` · ★ 142</sub>
...
- [kanarenshu](https://github.com/nuixyz/kanarenshu) - A minimal TUI application to practise Japanese from the terminal. <sub>`Go` · ★ 127</sub>
- [sigye](https://github.com/am2rican5/sigye) - A beautiful terminal clock with ASCII art fonts. <sub>`Rust` · ★ 125</sub>
...
- [ttymap](https://github.com/Kohei-Wada/ttymap) - Mapscii-inspired Terminal-native scriptable globe. <sub>`Rust` · ★ 120</sub>
- [tinifier](https://github.com/tarampampam/tinifier) - 🐼 CLI tool for compressing images using the TinyPNG. <sub>`Go` · ★ 116</sub>
...
- [aria2tui](https://github.com/grimandgreedy/aria2tui) - Aria2TUI is a TUI client for the Aria2 download utility. <sub>`Python` · ★ 93</sub>
...
- [rustormy](https://github.com/Tairesh/rustormy) - 🌦️ Minimal neofetch-like weather CLI. <sub>`Rust` · ★ 87</sub>
...
- [tuiweathergirl](https://github.com/StrayFeral/tuiweathergirl) - Terminal Weather and Disaster Station (Linux/Windows/Unix/MacOS) <sub>`Python` · ★ 24</sub>
...
- [gsty](https://github.com/tappunk/gsty) - Live-preview Ghostty theme browser and installer. <sub>`Rust` · ★ 12</sub>
...
- [starwheel](https://github.com/Igfray/starwheel) - A live planisphere in your terminal. Real star positions for your location and clock, drawn in braille. <sub>`JavaScript` · ★ 5 · [deep dive](https://awesometui.com/starwheel)</sub>
...
Projects with a full deep-dive page on awesometui.com — overview, source-backed install options, keybindings, and screenshots. All 98 are marked **deep dive** throughout this list; here are the most-starred.
...
| [herdr](https://github.com/herdrdev/herdr) | The runtime your coding agents live on. | Rust | 36k | [deep dive](https://awesometui.com/herdr) |
...
| [hunk](https://github.com/modem-dev/hunk) | Review-first terminal diff viewer for agentic coders. | TypeScript | 9.1k | [deep dive](https://awesometui.com/hunk) |
| [cliamp](https://github.com/bjarneo/cliamp) | Cliamp - Terminal music player inspired by winamp. | Go | 4k | [deep dive](https://awesometui.com/cliamp) |
...
<sub>Synced 2026-09-07 10:24 UTC from <a href="https://awesometui.com">awesometui.com</a> · 1,333 projects · Made for people who love the terminal.</sub>
